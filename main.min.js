sounds={menu2:new Howl({src:["sfx/menu2.mp3"],volume:.5,sprite:{menu2Start:[0,1300],menu2Loop:[1300,55500]},onend:function(){this.play("menu2Loop");console.log("test")}}),battlefield:new Howl({src:["sfx/battlefield.mp3"],sprite:{battlefieldStart:[0,8E3],battlefieldLoop:[8E3,75200]},volume:.5,onend:function(){this.play("battlefieldLoop");console.log("test2")}}),menuBack:new Howl({src:["sfx/menu-back.wav"]}),menuForward:new Howl({src:["sfx/menu-forward.wav"]}),menuSelect:new Howl({src:["sfx/menu-select.wav"]}),
marth:new Howl({src:["sfx/marth.wav"]}),ready:new Howl({src:["sfx/ready.wav"]}),go:new Howl({src:["sfx/go.wav"]}),game:new Howl({src:["sfx/game.wav"]}),dash:new Howl({src:["sfx/dash.wav"],volume:.5}),tech:new Howl({src:["sfx/tech.wav"]}),airdodge:new Howl({src:["sfx/airdodge.wav"]}),dolphinSlash:new Howl({src:["sfx/dolphin-slash.wav"]}),dolphinSlash2:new Howl({src:["sfx/dolphin-slash2.wav"]}),grab:new Howl({src:["sfx/grab.wav"]}),grabbed:new Howl({src:["sfx/grabbed.wav"]}),jump:new Howl({src:["sfx/jump.wav"]}),
jump2:new Howl({src:["sfx/jump2.wav"]}),kill:new Howl({src:["sfx/kill.wav"]}),land:new Howl({src:["sfx/land.wav"]}),ledgegrab:new Howl({src:["sfx/ledgegrab.wav"]}),powershield:new Howl({src:["sfx/powershield.wav"]}),roll:new Howl({src:["sfx/roll.wav"]}),shieldbreak:new Howl({src:["sfx/shieldbreak.wav"]}),shieldup:new Howl({src:["sfx/shieldup.wav"]}),swordsheath:new Howl({src:["sfx/swordsheath.wav"]}),sworddraw:new Howl({src:["sfx/sworddraw.wav"]}),fastfall:new Howl({src:["sfx/fastfall.wav"]}),spotdodge:new Howl({src:["sfx/spotdodge.wav"]}),
dancingBlade:new Howl({src:["sfx/dancing-blade.wav"]}),shieldoff:new Howl({src:["sfx/shieldoff.wav"]}),runbrake:new Howl({src:["sfx/runbrake.wav"]}),shout1:new Howl({src:["sfx/shout1.wav"]}),shout2:new Howl({src:["sfx/shout2.wav"]}),shout3:new Howl({src:["sfx/shout3.wav"]}),shout4:new Howl({src:["sfx/shout4.wav"]}),shout5:new Howl({src:["sfx/shout5.wav"]}),shout6:new Howl({src:["sfx/shout6.wav"]}),sword1:new Howl({src:["sfx/sword1.wav"]}),sword2:new Howl({src:["sfx/sword2.wav"]}),sword3:new Howl({src:["sfx/sword3.wav"]}),
footstep:new Howl({src:["sfx/footstep.wav"]}),smashcharge:new Howl({src:["sfx/smashcharge.wav"]}),deathShout:new Howl({src:["sfx/death.wav"]}),walljump:new Howl({src:["sfx/walljump.wav"]}),weakhurt:new Howl({src:["sfx/weakhurt.wav"]}),stronghurt:new Howl({src:["sfx/stronghurt.wav"]}),swordweakhit:new Howl({src:["sfx/swordweakhit.wav"]}),swordmediumhit:new Howl({src:["sfx/swordmediumhit.wav"]}),swordstronghit:new Howl({src:["sfx/swordstronghit.wav"]}),swordreallystronghit:new Howl({src:["sfx/swordreallystronghit.wav"]}),
stronghit:new Howl({src:["sfx/stronghit.wav"]}),strongerhit:new Howl({src:["sfx/strongerhit.wav"]}),normalweakhit:new Howl({src:["sfx/normalweakhit.wav"]}),cheer:new Howl({src:["sfx/cheer.wav"]}),lowdown:new Howl({src:["sfx/lowdown.wav"]}),bounce:new Howl({src:["sfx/bounce.wav"]}),pause:new Howl({src:["sfx/pause.wav"]}),furacry:new Howl({src:["sfx/furacry.wav"]}),furaloop:new Howl({src:["sfx/furaloop.wav"],loop:!0})};function playSfx(a){sounds[a].play()}
...
0;e<b.length;e++){var f=.2*b[e][0]*d+4.5*vfxQueue[a][2].x+600,n=.2*b[e][1]+-4.5*vfxQueue[a][2].y+480;0==e?c.moveTo(f,n):2<b[e].length?c.bezierCurveTo(f,n,.2*b[e][2]*d+4.5*vfxQueue[a][2].x+600,.2*b[e][3]+-4.5*vfxQueue[a][2].y+480,.2*b[e][4]*d+4.5*vfxQueue[a][2].x+600,.2*b[e][5]+-4.5*vfxQueue[a][2].y+480):c.lineTo(f,n)}c.closePath();c.fill()},impactLand:function(a){dVfx.general(a,0)},circleDust:function(a){for(var b=0;b<vfxQueue[a][0].circles.length;b++){var d=4.5*(vfxQueue[a][2].x+vfxQueue[a][0].circles[b]*
...
Math.PI),c.closePath(),c.stroke(),c.beginPath(),c.arc(0,0,23,1.35*Math.PI,1.65*Math.PI),c.closePath(),c.fill();c.restore()},start:function(a){1==vfxQueue[a][1]&&playSfx("ready");90==vfxQueue[a][1]&&playSfx("go");if(90>vfxQueue[a][1]){var b=c.createLinearGradient(0,200,0,500);b.addColorStop(0,"rgb(255, 51, 51)");b.addColorStop(.6,"rgb(255, 51, 51)");b.addColorStop(1,"rgb(121, 0, 0)");c.save();c.fillStyle=b;c.textAlign="start";c.lineWidth=20;c.strokeStyle="black";c.font="italic 900 200px Arial";c.strokeText("Ready",
240,420);c.lineWidth=10;c.strokeStyle="white";c.strokeText("Ready",240,420);c.fillText("Ready",240,420);c.fillStyle="rgb("+Math.round(2.6*vfxQueue[a][1])+","+Math.round(140-1.5*vfxQueue[a][1])+","+Math.round(255-2.6*vfxQueue[a][1])+")";c.font="italic 700 70px Arial";b=(2*startTimer%1).toFixed(2);c.strokeStyle="black";c.strokeText(Math.floor(2*startTimer)+" "+b[2]+b[3],900,500);c.fillText(Math.floor(2*startTimer)+" "+b[2]+b[3],900,500);c.fillStyle="rgba(255,0,0,0.2)";c.fillRect(240,450,520,15);b=c.createLinearGradient(240+
vfxQueue[a][1]/90*500,450,760+vfxQueue[a][1]/90*500,465);b.addColorStop(0,"#ff0000");b.addColorStop(.16,"#ff00ff");b.addColorStop(.33,"#0000ff");b.addColorStop(.49,"#00ffff");b.addColorStop(.66,"#00ff00");b.addColorStop(.83,"#ffff00");b.addColorStop(1,"#ff0000");c.fillStyle=b;c.fillRect(240+vfxQueue[a][1]/90*500,450,520-vfxQueue[a][1]/90*500,15)}else b=c.createLinearGradient(0,200,0,480),b.addColorStop(0,"black"),b.addColorStop(.6,"black"),b.addColorStop(1,"rgb(221, 145, 57)"),c.save(),c.fillStyle=
b,c.textAlign="start",c.lineWidth=40,c.strokeStyle="black",c.font="900 400px Arial",c.strokeText("Go!",240,470),c.lineWidth=20,c.strokeStyle="white",c.strokeText("Go!",240,470),c.fillText("Go!",240,470);c.restore()},entrance:function(a){c.save();c.translate(4.5*vfxQueue[a][2].x+600,-4.5*vfxQueue[a][2].y+480);for(var b=0,d=vfxQueue[a][1]*Math.PI/32,e=0;8>e;e++){var f=Math.random()-.5,b=new Vec2D(35*Math.cos(d),14*Math.sin(d)),n=c.createLinearGradient(0,0,0,2*-vfxQueue[a][1]-60*f);n.addColorStop(0,
"rgba(255, 255, 255, 0.3)");n.addColorStop(.5,"rgba(255, 255, 255, 0.3)");n.addColorStop(1,"rgba(255, 255, 255, 0.0)");c.fillStyle=n;c.fillRect(b.x,b.y-(2*vfxQueue[a][1]+60*f),10,2*vfxQueue[a][1]+60*f);d+=Math.PI/4}c.fillStyle="rgba(163, 255, 203, 0.3)";c.fillRect(-35,5*-(vfxQueue[a][1]%15),80,15);c.restore();c.save();c.translate(4.5*vfxQueue[a][2].x+600,-4.5*vfxQueue[a][2].y+480);c.strokeStyle="rgba(255, 149, 149, 0.8)";c.lineWidth=8;c.scale(.8+.3*Math.random(),.2+.2*Math.random());c.beginPath();
c.arc(5,3*-vfxQueue[a][1],35+vfxQueue[a][1]%2*10,0,twoPi);c.closePath();c.stroke();c.restore()}};hitQueue=[];angleConversion=Math.PI/180;
function hitDetection(a){for(var b=0;4>b;b++)if(-1<playerType[b]&&b!=a&&1!=player[b].phys.hurtBoxState){for(var d=!1,e=0;e<player[a].hitboxes.hitList.length;e++)if(b==player[a].hitboxes.hitList[e]){d=!0;break}if(!d)for(d=0;4>d;d++)if(player[a].hitboxes.active[d]&&(!player[a].phys.thrownHitbox||player[a].phys.thrownHitboxOwner!=b))if(player[b].phys.shielding&&hitShieldCollision(b,a,d)){hitQueue.push([b,a,d,!0,!1,!1]);player[a].hitboxes.hitList.push(b);break}else if(hitHurtCollision(b,a,d)){hitQueue.push([b,
a,d,!1,!1,!1]);player[a].hitboxes.hitList.push(b);break}}}function hitShieldCollision(a,b,d){var e=new Vec2D(player[b].phys.pos.x+player[b].hitboxes["id"+d].offset[player[b].hitboxes.frame].x*player[b].phys.face,player[b].phys.pos.y+player[b].hitboxes["id"+d].offset[player[b].hitboxes.frame].y),f=player[a].phys.shieldPositionReal;return Math.pow(f.x-e.x,2)+Math.pow(e.y-f.y,2)<=Math.pow(player[b].hitboxes["id"+d].size+player[a].phys.shieldSize,2)}
...
function executeHits(){for(var a=0;a<hitQueue.length;a++){var b=hitQueue[a][0],d=hitQueue[a][1],e=hitQueue[a][2],f=hitQueue[a][3],n=hitQueue[a][4],q=hitQueue[a][5];if(2==player[d].hitboxes["id"+e].type)-1==player[b].phys.grabbedBy&&-1==player[d].phys.grabbing&&0==player[b].phys.hurtBoxState&&(player[b].phys.cVel=new Vec2D(0,0),player[b].phys.kVel=new Vec2D(0,0),player[d].phys.cVel=new Vec2D(0,0),player[d].phys.kVel=new Vec2D(0,0),player[b].phys.grabbedBy=d,player[b].phys.shielding=!1,player[d].phys.grabbing=
b,aS[74].init(b));else{var h=player[d].hitboxes["id"+e].dmg;player[d].phys.charging&&(h*=1+.3671/60*player[d].phys.chargeFrames);player[d].hit.hitlag=Math.floor(1/3*h+3);if(f){if(!player[b].phys.powerShieldActive&&(player[b].phys.shieldHP-=h,0>player[b].phys.shieldHP)){player[b].phys.shielding=!1;player[b].phys.cVel.y=2.5;player[b].phys.grounded=!1;player[b].phys.shieldHP=0;drawVfx("breakShield",player[b].phys.pos,player[b].phys.face);aS[69].init(b);break}player[b].hit.hitlag=Math.floor(1/3*h+3);
e=.6;player[b].phys.powerShieldActive&&(e=1,player[b].phys.powerShielded=!0,player[b].hit.powershield=!0,drawVfx("powerShield",player[b].phys.shieldPositionReal,player[b].phys.face,player[b].phys.shieldSize));player[b].hit.shieldstun=Math.floor(h)*(.65*(1-(player[b].phys.shieldAnalog-.3)/.7)+.3)*1.5+2;e*=Math.floor(h)*(.195*(1-(player[b].phys.shieldAnalog-.3)/.7)+.09)+.4;2<e&&(e=2);h=.1*Math.floor(h)*(player[b].phys.shieldAnalog-.3)+.02;player[d].phys.pos.x<player[b].phys.pos.x?(player[b].phys.cVel.x+=
e,player[d].phys.cVel.x-=h):(player[b].phys.cVel.x-=e,player[d].phys.cVel.x+=h)}else 0==player[b].phys.hurtBoxState&&(player[b].hit.knockback=getKnockback(player[d].hitboxes["id"+e],h,h,player[b].percent,player[b].charAttributes.weight),player[b].hit.angle=player[d].hitboxes["id"+e].angle,361==player[b].hit.angle&&(32.1>player[b].hit.knockback?player[b].hit.angle=0:32.1<=player[b].hit.knockback&&(player[b].hit.angle=44)),player[b].hit.hitlag=Math.floor(1/3*h+3),n?(player[b].phys.thrownHitbox=!0,player[b].phys.thrownHitboxOwner=
d,player[b].phys.pos=new Vec2D(player[d].phys.pos.x+player[d].hitboxes["id"+e].offset.x*player[d].phys.face,player[d].phys.pos.y+player[d].hitboxes["id"+e].offset.y),player[b].phys.grabbedBy=-1,player[b].hit.hitlag=1,player[d].hit.hitlag=1,player[b].hit.reverse=1==player[d].phys.face?!1:!0,q&&(playSfx("bounce"),drawVfx("groundBounce",player[b].phys.pos,player[b].phys.face))):(player[b].hit.hitPoint=new Vec2D(player[d].phys.pos.x+player[d].hitboxes["id"+e].offset[player[d].hitboxes.frame].x*player[d].phys.face,
player[d].phys.pos.y+player[d].hitboxes["id"+e].offset[player[d].hitboxes.frame].y),player[d].phys.pos.x<player[b].phys.pos.x?(player[b].hit.reverse=!1,player[b].phys.face=-1):(player[b].hit.reverse=!0,player[b].phys.face=1)),player[b].percent+=h,-1==player[b].phys.grabbedBy||44<player[b].hit.knockback?(player[b].hit.hitstun=getHitstun(player[b].hit.knockback),80<=player[b].hit.knockback||n?aS[39].init(b,!n):aS[41].init(b)):aS[80].init(b),player[b].phys.grounded&&180<player[b].hit.angle&&80<=player[b].hit.knockback&&
(playSfx("bounce"),drawVfx("groundBounce",player[b].phys.pos,player[b].phys.face),player[b].hit.angle=360-player[b].hit.angle,player[b].hit.knockback*=.8),screenShake(player[b].hit.knockback),percentShake(player[b].hit.knockback,b),n?playSfx("stronghit"):0==player[d].hitboxes["id"+e].effect?playSfx("normalweakhit"):50>player[b].hit.knockback?playSfx("swordweakhit"):100>player[b].hit.knockback?playSfx("swordmediumhit"):140>player[b].hit.knockback?playSfx("swordstronghit"):(playSfx("swordreallystronghit"),
playSfx("cheer"),280>player[b].hit.knockback?(playSfx("stronghit"),playSfx("weakhurt")):(playSfx("strongerhit"),playSfx("stronghurt"))))}}}function getKnockback(a,b,d,e,f){a=0==a.sk?.01*a.kg*(1.4*(.05*d*(b+Math.floor(e))+.1*(b+Math.floor(e)))*(2-.02*f/(1+.01*f))+18)+a.bk:a.kg/100*(200/(f+100)*(10*a.sk/20+1)*1.4+18)+a.bk;2500<a&&(a=2500);return a}
function getLaunchAngle(a,b,d,e,f,n){var q=!1,h;80>b&&player[n].phys.grounded&&(0==a||180==a)&&(q=!0);.2875>e&&-.2875<e&&(e=0);.2875>f&&-.2875<f&&(f=0);0==e&&0>f?h=270:0==e&&0<f?h=90:0==e&&0==f?q=!0:(h=180/Math.PI*Math.atan(f/e)*1,0>e?h+=180:0>f&&(h+=360));361==a?32.1>b?a=d?180:0:32.1<=b?a=d?136:44:(prompt("Why would this ever get called?"),a=440*(b-32),d&&(a=180-a,0>a&&(a=360+a))):d&&(a=180-a,0>a&&(a=360+a));q?e=0:(b=a-h,180<b&&(b-=360),e=Math.sin(b*angleConversion)*Math.sqrt(e*e+f*f),e=e*e*18,18<
...
function charAttributes(a,b,d,e,f,n,q,h,m,g){this.dFrameMin=a;this.dFrameMax=b;this.dInitV=d;this.dMaxV=e;this.dAccA=f;this.dAccB=n;this.dTInitV=q;this.traction=h;this.maxWalk=m;this.jumpSquat=g;this.sHopInitV=1.5;this.fHopInitV=2.4;this.gravity=.085;this.groundToAir=.8;this.jumpHmaxV=1.2;this.jumpHinitV=1;this.terminalV=2.2;this.airMobA=.03;this.airMobB=.02;this.aerialHmaxV=.9;this.airFriction=.005;this.fastFallV=2.5;this.walkInitV=.15;this.walkAcc=0;this.walkMaxV=1.6;this.djMultiplier=.88;this.shieldScale=
...
5,135,50,65,0,0)),throwback:new hitboxObject(new hitbox(new Vec2D(-1.29306,0),0,4,117,60,70,0,0)),throwforward:new hitboxObject(new hitbox(new Vec2D(7.69851,0),0,4,50,45,70,0,0)),thrown:new hitboxObject(new hitbox(offsets.thrown.id0,3.906,4,361,50,20,0,1))}}function hitboxObject(a,b,d,e){this.id0=a;this.id1=b;this.id2=d;this.id3=e}function hitbox(a,b,d,e,f,n,q,h){this.offset=a;this.size=b;this.dmg=d;this.angle=e;this.kg=f;this.bk=n;this.sk=q;this.type=h}
function actionState(a,b,d){this.totalFrames=a;this.timer=0;this.name=b;this.hb=d}chars={marth:new charObject(new charAttributes(15,27,1.56,1.8,.06,0,1.5,.06,1.6,4))};function ActiveHitbox(a,b,d,e,f,n,q,h){this.size=a;this.offset=b;this.dmg=d;this.angle=e;this.kg=f;this.bk=n;this.sk=q;this.type=h}
...
.62<player[a].inputs.lStickAxis[0].x*player[a].phys.face?(aS[2].init(a),!0):player[a].timer>player[a].charAttributes.dFrameMax?(aS[0].init(a),!0):!1}},{name:"RUN",canEdgeCancel:!0,init:function(a){player[a].actionState=2;player[a].timer=1;aS[2].main(a)},main:function(a){16<player[a].timer&&(player[a].timer=1);if(!aS[2].interrupt(a)){var b=[!1,!1];2>player[a].timer&&(b[0]=!0);10>player[a].timer&&(b[1]=!0);var d=player[a].inputs.lStickAxis[0].x*player[a].charAttributes.dMaxV;player[a].phys.cVel.x+=
...
0>d&&player[a].phys.cVel.x>d)player[a].phys.cVel.x+=player[a].charAttributes.walkInitV*player[a].phys.face}aS[7].main(a)},main:function(a){if(!aS[7].interrupt(a)){var b=[!1,!1];5>player[a].timer&&(b[0]=!0);15>player[a].timer&&(b[1]=!0);var d=player[a].charAttributes.walkMaxV*player[a].inputs.lStickAxis[0].x;Math.abs(player[a].phys.cVel.x)>Math.abs(d)?reduceByTraction(a,!0):(player[a].phys.cVel.x+=1/(2*player[a].charAttributes.walkMaxV)*(d-player[a].phys.cVel.x)*(player[a].charAttributes.walkInitV+
player[a].charAttributes.walkAcc),player[a].phys.cVel.x*player[a].phys.face>d*player[a].phys.face&&(player[a].phys.cVel.x=d));d=player[a].phys.cVel.x*player[a].phys.face/player[a].charAttributes.walkMaxV;0<d&&(player[a].timer+=d);(b[0]&&5<=player[a].timer||b[1]&&15<=player[a].timer)&&playSfx("footstep")}},interrupt:function(a){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);return 18<player[a].timer?(aS[7].init(a,!1),!0):0==player[a].inputs.lStickAxis[0].x?(aS[0].init(a),!0):checkForJump(a)?
(aS[8].init(a),!0):player[a].inputs.l[0]||player[a].inputs.r[0]||0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0]?(aS[21].init(a),!0):b[0]?(aS[b[1]].init(a),!0):e[0]?(aS[e[1]].init(a),!0):d[0]?(aS[d[1]].init(a),!0):checkForSquat(a)?(aS[16].init(a),!0):checkForDash(a)?(aS[1].init(a),!0):checkForSmashTurn(a)?(aS[3].init(a),!0):checkForTiltTurn(a)?(player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0):!1}},{name:"KNEEBEND",canEdgeCancel:!0,init:function(a){player[a].actionState=
8;player[a].timer=0;player[a].phys.jumpType=1;aS[8].main(a)},main:function(a){player[a].timer++;aS[8].interrupt(a)||(reduceByTraction(a,!0),player[a].inputs.x[0]||player[a].inputs.y[0]||(player[a].phys.jumpType=0))},interrupt:function(a){var b=checkForSpecials(a);return player[a].timer>player[a].charAttributes.jumpSquat?(-.3<=player[a].inputs.lStickAxis[2].x*player[a].phys.face?aS[9].init(a,player[a].phys.jumpType):aS[15].init(a,player[a].phys.jumpType),!0):player[a].inputs.a[0]&&!player[a].inputs.a[1]&&
(0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0])?(aS[73].init(a),!0):player[a].inputs.a[0]&&!player[a].inputs.a[1]&&.8<=player[a].inputs.lStickAxis[0].y&&.3>player[a].inputs.lStickAxis[3].y||.8<=player[a].inputs.cStickAxis[0].y&&.3>player[a].inputs.cStickAxis[3].y?(aS[58].init(a),!0):b[0]?(aS[b[1]].init(a),!0):!1}},{name:"JUMPF",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a,b){player[a].actionState=9;player[a].timer=0;player[a].phys.cVel.y=b?player[a].phys.cVel.y+
player[a].charAttributes.fHopInitV:player[a].phys.cVel.y+player[a].charAttributes.sHopInitV;player[a].phys.cVel.x=player[a].phys.cVel.x*player[a].charAttributes.groundToAir+player[a].inputs.lStickAxis[0].x*player[a].charAttributes.jumpHmaxV;Math.abs(player[a].phys.cVel.x)>player[a].charAttributes.jumpHmaxV&&(player[a].phys.cVel.x=player[a].charAttributes.jumpHmaxV*Math.sign(player[a].phys.cVel.x));player[a].phys.grounded=!1;playSfx("jump");playSfx("jump2");aS[9].main(a)},main:function(a){player[a].timer++;
!aS[9].interrupt(a)&&1<player[a].timer&&(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):
d[0]?(aS[d[1]].init(a),!0):45<player[a].timer?(aS[13].init(a),!0):!1}},{name:"LANDING",canEdgeCancel:!0,init:function(a){player[a].actionState=10;player[a].timer=0;drawVfx("impactLand",player[a].phys.pos,player[a].phys.face);drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[10].main(a)},main:function(a){player[a].timer++;aS[10].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){if(4<player[a].timer&&30>=player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),
e=checkForSmashes(a);return checkForJump(a)?(aS[8].init(a),!0):player[a].inputs.l[0]||player[a].inputs.r[0]||0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0]?(aS[21].init(a),!0):b[0]?(aS[b[1]].init(a),!0):e[0]?(aS[e[1]].init(a),!0):d[0]?(aS[d[1]].init(a),!0):checkForDash(a)?(aS[1].init(a),!0):checkForSmashTurn(a)?(aS[3].init(a),!0):checkForTiltTurn(a)?(player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0):.3<Math.abs(player[a].inputs.lStickAxis[0].x)?(aS[7].init(a,!0),!0):
5==player[a].timer&&-.5>player[a].inputs.lStickAxis[0].y?(aS[17].init(a),!0):!1}return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"ESCAPEAIR",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=11;player[a].timer=0;if(0<Math.abs(player[a].inputs.lStickAxis[0].x)||0<Math.abs(player[a].inputs.lStickAxis[0].y)){var b=getAngle(player[a].inputs.lStickAxis[0].x,player[a].inputs.lStickAxis[0].y);player[a].phys.cVel.x=3.1*Math.cos(b);player[a].phys.cVel.y=3.1*
Math.sin(b)}else player[a].phys.cVel.x=0,player[a].phys.cVel.y=0;player[a].phys.fastfalled=!1;aS[11].main(a)},main:function(a){player[a].timer++;aS[11].interrupt(a)||(30>player[a].timer?(player[a].phys.cVel.x*=.9,player[a].phys.cVel.y*=.9):(airDrift(a),fastfall(a)),4==player[a].timer&&(player[a].phys.intangibleTimer=25,playSfx("airdodge")))},interrupt:function(a){return 49<player[a].timer?(aS[14].init(a),!0):!1}},{name:"LANDINGFALLSPECIAL",canEdgeCancel:!0,init:function(a){player[a].actionState=12;
player[a].timer=0;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[12].main(a)},main:function(a){player[a].timer+=3;aS[12].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"FALL",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=13;player[a].timer=0;aS[13].main(a)},main:function(a){player[a].timer++;aS[13].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=
...
playSfx("jump2");aS[19].main(a)},main:function(a){player[a].timer++;aS[19].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):d[0]?(aS[d[1]].init(a),!0):50<player[a].timer?(aS[32].init(a),!0):!1}},{name:"PASS",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=
20;player[a].timer=0;player[a].phys.grounded=!1;player[a].phys.passFastfall=!1;player[a].phys.abovePlatforms[player[a].phys.onSurface]=!1;player[a].phys.cVel.y=-.5;aS[20].main(a)},main:function(a){player[a].timer++;1<player[a].timer&&!aS[20].interrupt(a)&&(player[a].phys.passFastfall?fastfall(a):(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=-player[a].charAttributes.terminalV),-.3<player[a].inputs.lStickAxis[0].y&&
...
!0):30<player[a].timer?(aS[13].init(a),!0):!1}},{name:"GUARDON",canEdgeCancel:!0,init:function(a){player[a].actionState=21;player[a].timer=0;player[a].phys.shielding=!0;player[a].phys.shieldPosition=new Vec2D(0,0);player[a].phys.powerShielded=!1;shieldSize(a,!0);player[a].phys.powerShieldActive=1==Math.max(player[a].inputs.lAnalog[0],player[a].inputs.rAnalog[0])?!0:!1;aS[21].main(a)},main:function(a){0<player[a].hit.shieldstun?reduceByTraction(a,!1):(player[a].timer++,2==player[a].timer&&1==Math.max(player[a].inputs.lAnalog[0],
player[a].inputs.rAnalog[0])&&(player[a].phys.powerShieldActive=!0),aS[21].interrupt(a)||(1==player[a].timer&&(playSfx("shieldup"),playSfx("swordsheath")),reduceByTraction(a,!1),0>=player[a].hit.shieldstun&&(shieldDepletion(a),shieldSize(a,!0),shieldTilt(a))))},interrupt:function(a){return player[a].inCSS?8<player[a].timer?(aS[22].init(a),!0):!1:checkForJump(a)||.6<player[a].inputs.cStickAxis[0].y&&.3>player[a].inputs.cStickAxis[3].y?(player[a].phys.shielding=!1,aS[8].init(a),!0):player[a].inputs.a[0]&&
!player[a].inputs.a[1]?(player[a].phys.shielding=!1,aS[73].init(a),!0):-.7>player[a].inputs.lStickAxis[0].y&&-.3<player[a].inputs.lStickAxis[4].y||-.7>player[a].inputs.cStickAxis[0].y?(player[a].phys.shielding=!1,aS[54].init(a),!0):.7<player[a].inputs.lStickAxis[0].x*player[a].phys.face&&.3>player[a].inputs.lStickAxis[4].x*player[a].phys.face||.7<player[a].inputs.cStickAxis[0].x*player[a].phys.face?(player[a].phys.shielding=!1,aS[53].init(a),!0):-.7>player[a].inputs.lStickAxis[0].x*player[a].phys.face&&
-.3<player[a].inputs.lStickAxis[4].x*player[a].phys.face||-.7>player[a].inputs.cStickAxis[0].x*player[a].phys.face?(player[a].phys.shielding=!1,aS[52].init(a),!0):1<player[a].timer&&-.65>player[a].inputs.lStickAxis[0].y&&-.3<player[a].inputs.lStickAxis[6].y&&-1<player[a].phys.onSurface?(player[a].phys.shielding=!1,aS[20].init(a),!0):8<player[a].timer?(aS[22].init(a),!0):!1}},{name:"GUARD",canEdgeCancel:!0,init:function(a){player[a].actionState=22;player[a].timer=0;player[a].phys.powerShieldActive=
!1;aS[22].main(a)},main:function(a){0<player[a].hit.shieldstun?reduceByTraction(a,!1):(player[a].timer++,aS[22].interrupt(a)||(player[a].inCSS||(reduceByTraction(a,!1),shieldDepletion(a),shieldTilt(a)),shieldSize(a)))},interrupt:function(a){return player[a].inCSS?.3>player[a].inputs.lAnalog[0]&&.3>player[a].inputs.rAnalog[0]?(player[a].phys.shielding=!1,aS[23].init(a),!0):1<player[a].timer?(aS[22].init(a),!0):!1:checkForJump(a)||.6<player[a].inputs.cStickAxis[0].y&&.3>player[a].inputs.cStickAxis[3].y?
...
aS[53].init(a),!0):-.7>player[a].inputs.lStickAxis[0].x*player[a].phys.face&&-.3<player[a].inputs.lStickAxis[4].x*player[a].phys.face||-.7>player[a].inputs.cStickAxis[0].x*player[a].phys.face?(player[a].phys.shielding=!1,aS[52].init(a),!0):-.65>player[a].inputs.lStickAxis[0].y&&-.3<player[a].inputs.lStickAxis[6].y&&-1<player[a].phys.onSurface?(player[a].phys.shielding=!1,aS[20].init(a),!0):.3>player[a].inputs.lAnalog[0]&&.3>player[a].inputs.rAnalog[0]?(player[a].phys.shielding=!1,aS[23].init(a),!0):
1<player[a].timer?(aS[22].init(a),!0):!1}},{name:"GUARDOFF",canEdgeCancel:!0,init:function(a){player[a].actionState=23;player[a].timer=0;playSfx("shieldoff");aS[23].main(a)},main:function(a){player[a].timer++;aS[23].interrupt(a)||(6==player[a].timer&&playSfx("sworddraw"),reduceByTraction(a,!1),shieldDepletion(a),shieldSize(a))},interrupt:function(a){if(checkForJump(a)&&!player[a].inCSS)return aS[8].init(a),!0;if(16<player[a].timer)return aS[0].init(a),!0;if(player[a].phys.powerShielded){var b=checkForTilts(a),
d=checkForSmashes(a);if(d[0])return aS[d[1]].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(checkForSquat(a))return aS[16].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"CLIFFCATCH",init:function(a){player[a].actionState=24;player[a].timer=0;player[a].phys.cVel.x=
0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].phys.fastfalled=!1;player[a].phys.doubleJumped=!1;player[a].phys.intangibleTimer=38;player[a].phys.ledgeHangTimer=0;drawVfx("cliffcatchspark",new Vec2D(edges[player[a].phys.onLedge][0][0],edges[player[a].phys.onLedge][0][1]),player[a].phys.face);playSfx("ledgegrab");aS[24].main(a)},main:function(a){player[a].timer++;aS[24].interrupt(a)||(player[a].phys.pos=new Vec2D(cliffcatchOffset[player[a].timer-1][0]*player[a].phys.face,
...
90);isFinalDeath()||(screenShake(500),percentShake(500,a));playSfx("kill");playSfx("deathShout");aS[26].main(a)},main:function(a){player[a].timer++;aS[26].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),percentShake(500,a)))},interrupt:function(a){return 60<player[a].timer?(0<player[a].stocks?aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADRIGHT",init:function(a){player[a].actionState=27;player[a].timer=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=
0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,-90);isFinalDeath()||(screenShake(500),percentShake(500,a));playSfx("kill");playSfx("deathShout");aS[27].main(a)},main:function(a){player[a].timer++;aS[27].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),percentShake(500,a)))},interrupt:function(a){return 60<player[a].timer?(0<player[a].stocks?aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADUP",init:function(a){player[a].actionState=
...
aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADDOWN",init:function(a){player[a].actionState=29;player[a].timer=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,0);isFinalDeath()||(screenShake(500),percentShake(500,a));playSfx("kill");playSfx("deathShout");aS[29].main(a)},main:function(a){player[a].timer++;aS[29].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),
percentShake(500,a)))},interrupt:function(a){return 60<player[a].timer?(0<player[a].stocks?aS[30].init(a):aS[93].init(a),!0):!1}},{name:"REBIRTH",init:function(a){player[a].actionState=30;player[a].timer=1;player[a].phys.pos.x=respawnPoints[a][0];player[a].phys.pos.y=respawnPoints[a][1]+135;player[a].phys.cVel.x=0;player[a].phys.cVel.y=-1.5;player[a].phys.face=respawnPoints[a][2];player[a].phys.doubleJumped=!1;player[a].phys.fastfalled=!1;player[a].spawnWaitTime=0;player[a].percent=0;player[a].phys.kVel.x=
...
(player[a].phys.grounded=!1,player[a].phys.invincibleTimer=120,aS[13].init(a),!0):!1}},{name:"FALLAERIAL",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=32;player[a].timer=0;aS[32].main(a)},main:function(a){player[a].timer++;aS[32].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?
(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):10<player[a].timer?(aS[32].init(a),!0):!1}},{name:"ATTACKAIRF",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=33;player[a].timer=0;player[a].phys.autoCancel=!1;player[a].inAerial=!0;player[a].hitboxes.id0=
player[a].charHitboxes.fair.id0;player[a].hitboxes.id1=player[a].charHitboxes.fair.id1;player[a].hitboxes.id2=player[a].charHitboxes.fair.id2;player[a].hitboxes.id3=player[a].charHitboxes.fair.id3;turnOffHitboxes(a);aS[33].main(a)},main:function(a){player[a].timer++;aS[33].interrupt(a)||(fastfall(a),airDrift(a),2<player[a].timer&&11>player[a].timer&&drawVfx("swingFair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-
3),4==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword3")),4<player[a].timer&&8>player[a].timer&&player[a].hitboxes.frame++,8==player[a].timer&&turnOffHitboxes(a),27==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){if(33<player[a].timer)return aS[13].init(a),!0;if(29<player[a].timer){var b=checkForAerials(a);if((player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&
.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped)return aS[19].init(a),!0;if(b[0])return aS[b[1]].init(a),!0}return!1}},{name:"ATTACKAIRB",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=34;player[a].timer=0;player[a].phys.autoCancel=!1;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.bair.id0;player[a].hitboxes.id1=player[a].charHitboxes.bair.id1;player[a].hitboxes.id2=player[a].charHitboxes.bair.id2;
player[a].hitboxes.id3=player[a].charHitboxes.bair.id3;aS[34].main(a)},main:function(a){player[a].timer++;aS[34].interrupt(a)||(30==player[a].timer&&(player[a].phys.face*=-1),fastfall(a),airDrift(a),2<player[a].timer&&12>player[a].timer&&drawVfx("swingBair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-3),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword3")),
7<player[a].timer&&12>player[a].timer&&player[a].hitboxes.frame++,12==player[a].timer&&turnOffHitboxes(a),32==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){if(39<player[a].timer)return aS[13].init(a),!0;if(34<player[a].timer){var b=checkForAerials(a);if((player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped)return aS[19].init(a),
!0;if(b[0])return aS[b[1]].init(a),!0}return!1}},{name:"ATTACKAIRU",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=35;player[a].timer=0;player[a].phys.autoCancel=!0;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.upair.id0;player[a].hitboxes.id1=player[a].charHitboxes.upair.id1;player[a].hitboxes.id2=player[a].charHitboxes.upair.id2;player[a].hitboxes.id3=player[a].charHitboxes.upair.id3;aS[35].main(a)},main:function(a){player[a].timer++;
aS[35].interrupt(a)||(fastfall(a),airDrift(a),4<player[a].timer&&15>player[a].timer&&drawVfx("swingUpair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-5),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,player[a].phys.autoCancel=!1,playSfx("sword3")),5<player[a].timer&&9>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&turnOffHitboxes(a),27==player[a].timer&&
(player[a].phys.autoCancel=!0))},interrupt:function(a){return 45<player[a].timer?(aS[13].init(a),!0):!1}},{name:"ATTACKAIRD",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=36;player[a].timer=0;player[a].phys.autoCancel=!0;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dair.id0;player[a].hitboxes.id1=player[a].charHitboxes.dair.id1;player[a].hitboxes.id2=player[a].charHitboxes.dair.id2;player[a].hitboxes.id3=player[a].charHitboxes.dair.id3;
aS[36].main(a)},main:function(a){player[a].timer++;aS[36].interrupt(a)||(fastfall(a),airDrift(a),4<player[a].timer&&12>player[a].timer&&drawVfx("swingDair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-5),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,player[a].phys.autoCancel=!1,playSfx("sword3")),6<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&
turnOffHitboxes(a),48==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){return 59<player[a].timer?(aS[13].init(a),!0):!1}},{name:"ATTACKAIRN",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=37;player[a].timer=0;player[a].phys.autoCancel=!0;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.nair1.id0;player[a].hitboxes.id1=player[a].charHitboxes.nair1.id1;player[a].hitboxes.id2=player[a].charHitboxes.nair1.id2;
...
player[a].timer-3))},interrupt:function(a){return 39<player[a].timer?(aS[14].init(a),!0):!1}},{name:"DAMAGEFLYN",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a,b){player[a].actionState=39;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.grabbedBy=-1;b&&(drawVfx("hitSparks",player[a].hit.hitPoint,player[a].phys.face),drawVfx("hitFlair",player[a].hit.hitPoint,player[a].phys.face),drawVfx("hitCurve",player[a].hit.hitPoint,player[a].phys.face,player[a].hit.angle));player[a].hitboxes.id0=
player[a].charHitboxes.thrown.id0;turnOffHitboxes(a);aS[39].main(a)},main:function(a){player[a].phys.thrownHitbox&&(1==player[a].timer&&0<player[a].phys.cVel.y+player[a].phys.kVel.y&&(player[a].hitboxes.active=[!0,!1,!1,!1],player[a].hitboxes.frame=0),1<player[a].timer&&0<player[a].phys.cVel.y+player[a].phys.kVel.y&&player[a].hitboxes.frame++,0>=player[a].phys.cVel.y+player[a].phys.kVel.y&&turnOffHitboxes(a));29>player[a].timer&&player[a].timer++;0==player[a].hit.hitstun%10&&drawVfx("flyingDust",
player[a].phys.pos);aS[39].interrupt(a)?player[a].phys.thrownHitbox=!1:1<player[a].timer&&(player[a].hit.hitstun--,player[a].phys.grounded||(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){return 1<player[a].timer&&0==player[a].hit.hitstun?(aS[40].init(a),!0):!1}},{name:"DAMAGEFALL",canPassThrough:!1,canGrabLedge:[!0,!1],wallJumpAble:!1,init:function(a){player[a].actionState=
40;player[a].timer=0;turnOffHitboxes(a);aS[40].main(a)},main:function(a){player[a].timer++;aS[40].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&
!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):.7<player[a].inputs.lStickAxis[0].x&&.7>player[a].inputs.lStickAxis[1].x||-.7>player[a].inputs.lStickAxis[0].x&&-.7<player[a].inputs.lStickAxis[1].x||.7<player[a].inputs.lStickAxis[0].y&&.7>player[a].inputs.lStickAxis[1].y||-.7>player[a].inputs.lStickAxis[0].y&&-.7<player[a].inputs.lStickAxis[1].y?(aS[13].init(a),!0):30<player[a].timer?(aS[40].init(a),!0):!1}},{name:"DAMAGEN2",canEdgeCancel:!0,canPassThrough:!1,canGrabLedge:[!1,
!1],wallJumpAble:!1,init:function(a){player[a].actionState=41;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.grabbedBy=-1;turnOffHitboxes(a);drawVfx("hitSparks",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitFlair",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitCurve",player[a].hit.hitPoint,player[a].phys.face,player[a].hit.angle);aS[41].main(a)},main:function(a){player[a].timer++;!aS[41].interrupt(a)&&1<player[a].timer&&(player[a].hit.hitstun--,player[a].phys.grounded?
reduceByTraction(a,!1):(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){if(23<player[a].timer)return player[a].phys.grounded?aS[0].init(a):aS[13].init(a),!0;if(0>=player[a].hit.hitstun){if(player[a].phys.grounded){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);return checkForJump(a)?(aS[8].init(a),!0):player[a].inputs.l[0]||player[a].inputs.r[0]||
0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0]?(aS[21].init(a),!0):b[0]?(aS[b[1]].init(a),!0):e[0]?(aS[e[1]].init(a),!0):d[0]?(aS[d[1]].init(a),!0):checkForSquat(a)?(aS[16].init(a),!0):checkForDash(a)?(aS[1].init(a),!0):checkForSmashTurn(a)?(aS[3].init(a),!0):checkForTiltTurn(a)?(player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0):.3<Math.abs(player[a].inputs.lStickAxis[0].x)?(aS[7].init(a,!0),!0):!1}d=checkForAerials(a);b=checkForSpecials(a);if(d[0])return aS[d[1]].init(a),
...
-.7<player[a].inputs.lStickAxis[1].x||.7<player[a].inputs.lStickAxis[0].y&&.7>player[a].inputs.lStickAxis[1].y||-.7>player[a].inputs.lStickAxis[0].y&&-.7<player[a].inputs.lStickAxis[1].y)return aS[13].init(a),!0;if(30<player[a].timer)return aS[40].init(a),!0}return!1}},{name:"LANDINGATTACKAIRN",canEdgeCancel:!0,init:function(a){player[a].actionState=42;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");
aS[42].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;aS[42].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRF",canEdgeCancel:!0,init:function(a){player[a].actionState=43;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[43].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;
aS[43].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRB",canEdgeCancel:!0,init:function(a){player[a].actionState=44;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[44].main(a)},main:function(a){player[a].timer+=1.25*player[a].phys.landingLagScaling;aS[44].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<
player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRD",canEdgeCancel:!0,init:function(a){player[a].actionState=45;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[45].main(a)},main:function(a){player[a].timer+=.9375*player[a].phys.landingLagScaling;aS[45].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRU",
canEdgeCancel:!0,init:function(a){player[a].actionState=46;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);playSfx("land");aS[46].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;aS[46].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNTILT",canEdgeCancel:!1,init:function(a){player[a].actionState=47;player[a].timer=
0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dtilt.id0;player[a].hitboxes.id1=player[a].charHitboxes.dtilt.id1;player[a].hitboxes.id2=player[a].charHitboxes.dtilt.id2;player[a].hitboxes.id3=player[a].charHitboxes.dtilt.id3;aS[47].main(a)},main:function(a){player[a].timer++;aS[47].interrupt(a)||(reduceByTraction(a,!0),5<player[a].timer&&10>player[a].timer&&drawVfx("swingDtilt",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,
player[a].timer-6),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword2")),7<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(49<player[a].timer)return aS[17].init(a),!0;if(19<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),
!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(-.3>player[a].inputs.lStickAxis[0].x*player[a].phys.face&&Math.abs(player[a].inputs.lStickAxis[0].x)>-1*player[a].inputs.lStickAxis[0].y)return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<player[a].inputs.lStickAxis[0].x*player[a].phys.face&&Math.abs(player[a].inputs.lStickAxis[0].x)>-1*player[a].inputs.lStickAxis[0].y)return aS[7].init(a,!0),
!0}return!1}},{name:"UPTILT",canEdgeCancel:!1,init:function(a){player[a].actionState=48;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.uptilt1.id0;player[a].hitboxes.id1=player[a].charHitboxes.uptilt1.id1;player[a].hitboxes.id2=player[a].charHitboxes.uptilt1.id2;player[a].hitboxes.id3=player[a].charHitboxes.uptilt1.id3;aS[48].main(a)},main:function(a){player[a].timer++;aS[48].interrupt(a)||(reduceByTraction(a,!0),4<player[a].timer&&15>player[a].timer&&drawVfx("swingUptilt",
new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-5),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword2")),6<player[a].timer&&13>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&(player[a].hitboxes.frame=0,player[a].hitboxes.id0=player[a].charHitboxes.uptilt2.id0,player[a].hitboxes.id1=player[a].charHitboxes.uptilt2.id1,player[a].hitboxes.id2=player[a].charHitboxes.uptilt2.id2,
player[a].hitboxes.id3=player[a].charHitboxes.uptilt2.id3),13==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(39<player[a].timer)return aS[0].init(a),!0;if(31<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=
tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"FTILT",canEdgeCancel:!1,init:function(a){player[a].actionState=49;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.ftilt.id0;player[a].hitboxes.id1=player[a].charHitboxes.ftilt.id1;player[a].hitboxes.id2=player[a].charHitboxes.ftilt.id2;player[a].hitboxes.id3=player[a].charHitboxes.ftilt.id3;aS[49].main(a)},main:function(a){player[a].timer++;
aS[49].interrupt(a)||(reduceByTraction(a,!0),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword2")),7<player[a].timer&&11>player[a].timer&&player[a].hitboxes.frame++,11==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"JAB1",canEdgeCancel:!1,init:function(a){player[a].actionState=50;player[a].timer=0;player[a].phys.jabCombo=!1;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.jab1.id0;
player[a].hitboxes.id1=player[a].charHitboxes.jab1.id1;player[a].hitboxes.id2=player[a].charHitboxes.jab1.id2;player[a].hitboxes.id3=player[a].charHitboxes.jab1.id3;aS[50].main(a)},main:function(a){player[a].timer++;aS[50].interrupt(a)||(reduceByTraction(a,!0),2<player[a].timer&&26>player[a].timer&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(player[a].phys.jabCombo=!0),4==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword1")),4<player[a].timer&&
...
player[a].charHitboxes.jab2.id2;player[a].hitboxes.id3=player[a].charHitboxes.jab2.id3;aS[51].main(a)},main:function(a){player[a].timer++;aS[51].interrupt(a)||(reduceByTraction(a,!0),1<player[a].timer&&26>player[a].timer&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(player[a].phys.jabCombo=!0),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword1")),5<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a))},
interrupt:function(a){if(19<player[a].timer&&player[a].phys.jabCombo)return aS[50].init(a),!0;if(28<player[a].timer)return aS[0].init(a),!0;if(27<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=
tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"ESCAPEB",setVelocities:[-2.267,-2.536,-2.706,-2.78,-2.758,-2.64,-2.426,-2.116,-1.711,-1.209,-.888,-.819,-.758,-.707,-.664,-.631,-.606,-.591,-.585,-.587,-.599,-.62,-.809,-1.072,-1.205,-1.207,-1.078,-.819,-.617,-.556,-.487,-.413,-.332,-.245,-.152],canEdgeCancel:!1,init:function(a){player[a].actionState=52;player[a].timer=0;player[a].phys.shielding=!1;aS[52].main(a)},main:function(a){player[a].timer++;
aS[52].interrupt(a)||(33==player[a].timer&&playSfx("sworddraw"),player[a].phys.cVel.x=aS[52].setVelocities[player[a].timer-1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20,playSfx("roll")))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,aS[0].init(a),!0):!1}},{name:"ESCAPEF",setVelocities:[2.267,2.536,2.706,2.78,2.758,2.64,2.426,2.116,1.711,1.209,.888,.819,.758,.707,.664,.631,.606,.591,.585,.587,.599,.62,.809,1.072,1.205,1.207,1.078,.819,.617,
.556,.487,.413,.332,.245,.152],canEdgeCancel:!1,reverseModel:!0,init:function(a){player[a].actionState=53;player[a].timer=0;player[a].phys.shielding=!1;aS[53].main(a)},main:function(a){player[a].timer++;aS[53].interrupt(a)||(33==player[a].timer&&playSfx("sworddraw"),player[a].phys.cVel.x=aS[53].setVelocities[player[a].timer-1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20,playSfx("roll")))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,player[a].phys.face*=
-1,aS[0].init(a),!0):!1}},{name:"ESCAPEN",canEdgeCancel:!1,init:function(a){player[a].actionState=54;player[a].timer=0;player[a].phys.shielding=!1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[54].main(a)},main:function(a){player[a].timer++;aS[54].interrupt(a)||(1==player[a].timer&&playSfx("spotdodge"),2==player[a].timer&&playSfx("airdodge"),18==player[a].timer&&playSfx("sworddraw"),reduceByTraction(a,!0),2==player[a].timer&&(player[a].phys.intangibleTimer=16))},interrupt:function(a){return 27<
player[a].timer?(aS[0].init(a),!0):!1}},{name:"ATTACKDASH",canEdgeCancel:!1,setVelocities:[.755,1.962,2.714,3.01,2.849,2.232,1.184,.542,.704,1.325,1.487,1.079,.666,.631,.597,.565,.536,.508,.482,.458,.436,.416,.398,.37,.332,.299,.27,.244,.222,.205,.191,.181,.176,.165,.148,.13,.112,.093,.073,.053,.032,.011,-.783,-.783,0,0,.001,.001,0],init:function(a){player[a].actionState=55;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dashattack.id0;player[a].hitboxes.id1=player[a].charHitboxes.dashattack.id1;
player[a].hitboxes.id2=player[a].charHitboxes.dashattack.id2;player[a].hitboxes.id3=player[a].charHitboxes.dashattack.id3;aS[55].main(a)},main:function(a){player[a].timer++;aS[55].interrupt(a)||(player[a].phys.cVel.x=aS[55].setVelocities[player[a].timer-1]*player[a].phys.face,12==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword1")),12<player[a].timer&&16>player[a].timer&&player[a].hitboxes.frame++,16==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(49<
player[a].timer)return aS[0].init(a),!0;if(5>player[a].timer&&0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0])return player[a].phys.cVel.x*player[a].phys.face>player[a].charAttributes.dMaxV&&(player[a].phys.cVel.x=player[a].charAttributes.dMaxV*player[a].phys.face),aS[73].init(a),!0;if(39<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),
!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"SIDESPECIAL",canPassThrough:!1,canEdgeCancel:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=56;player[a].timer=0;player[a].phys.grounded?player[a].phys.cVel.x*=.2:(player[a].phys.sideBJumpFlag?
(player[a].phys.cVel.y=1,player[a].phys.sideBJumpFlag=!1):player[a].phys.cVel.y=0,player[a].phys.fastfalled=!1,player[a].phys.cVel.x*=.8);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.sidespecial.id0;player[a].hitboxes.id1=player[a].charHitboxes.sidespecial.id1;player[a].hitboxes.id2=player[a].charHitboxes.sidespecial.id2;player[a].hitboxes.id3=player[a].charHitboxes.sidespecial.id3;playSfx("shout6");aS[56].main(a)},main:function(a){player[a].timer++;aS[56].interrupt(a)||(6==player[a].timer&&
playSfx("dancingBlade"),player[a].phys.grounded?reduceByTraction(a,!0):(player[a].phys.cVel.y-=.06,0<player[a].phys.cVel.x?(player[a].phys.cVel.x-=.0025,0>player[a].phys.cVel.x&&(player[a].phys.cVel.x=0)):(player[a].phys.cVel.x+=.0025,0<player[a].phys.cVel.x&&(player[a].phys.cVel.x=0))),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),6<player[a].timer&&9>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 29<
...
player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,5==player[a].phys.chargeFrames&&playSfx("smashcharge"),60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=!1)):(player[a].timer++,player[a].phys.charging=!1):(player[a].timer++,player[a].phys.charging=!1);aS[57].interrupt(a)||(reduceByTraction(a,!0),5==player[a].timer&&playSfx("sword3"),10==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=
...
player[a].hitboxes.id3=player[a].charHitboxes.upsmash.id3;aS[58].main(a)},main:function(a){7==player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,5==player[a].phys.chargeFrames&&playSfx("smashcharge"),60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=!1)):(player[a].timer++,player[a].phys.charging=!1):(player[a].timer++,player[a].phys.charging=!1);aS[58].interrupt(a)||(reduceByTraction(a,!0),13==player[a].timer&&
...
!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"DSMASH",canEdgeCancel:!1,init:function(a){player[a].actionState=59;player[a].timer=0;player[a].phys.charging=!1;player[a].phys.chargeFrames=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dsmash1.id0;
player[a].hitboxes.id1=player[a].charHitboxes.dsmash1.id1;player[a].hitboxes.id2=player[a].charHitboxes.dsmash1.id2;player[a].hitboxes.id3=player[a].charHitboxes.dsmash1.id3;aS[59].main(a)},main:function(a){3==player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,5==player[a].phys.chargeFrames&&playSfx("smashcharge"),60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=!1)):(player[a].timer++,player[a].phys.charging=
!1):(player[a].timer++,player[a].phys.charging=!1);aS[59].interrupt(a)||(reduceByTraction(a,!0),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword3"),randomShout()),5<player[a].timer&&8>player[a].timer&&player[a].hitboxes.frame++,8==player[a].timer&&turnOffHitboxes(a),20==player[a].timer&&(player[a].hitboxes.id0=player[a].charHitboxes.dsmash2.id0,player[a].hitboxes.id1=player[a].charHitboxes.dsmash2.id1,player[a].hitboxes.id2=player[a].charHitboxes.dsmash2.id2,
player[a].hitboxes.id3=player[a].charHitboxes.dsmash2.id3,player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword3")),20<player[a].timer&&23>player[a].timer&&player[a].hitboxes.frame++,23==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(64<player[a].timer)return aS[0].init(a),!0;if(61<player[a].timer&&!player[a].inCSS){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),
!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"DOWNBOUND",canEdgeCancel:!0,init:function(a){player[a].actionState=60;player[a].timer=0;player[a].phys.kVel.y=0;drawVfx("groundBounce",player[a].phys.pos,
player[a].phys.face);playSfx("bounce");aS[60].main(a)},main:function(a){player[a].timer++;aS[60].interrupt(a)||(1==player[a].timer?reduceByTraction(a,!0):player[a].phys.cVel.x=0)},interrupt:function(a){return 26<player[a].timer?(aS[61].init(a),!0):!1}},{name:"DOWNWAIT",canEdgeCancel:!0,init:function(a){player[a].actionState=61;player[a].timer=0;aS[61].main(a)},main:function(a){player[a].timer++;aS[61].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 60<player[a].timer?(aS[61].init(a),
!0):-.7>player[a].inputs.lStickAxis[0].x*player[a].phys.face?(aS[63].init(a),!0):.7<player[a].inputs.lStickAxis[0].x*player[a].phys.face?(aS[64].init(a),!0):.7<player[a].inputs.lStickAxis[0].y?(aS[62].init(a),!0):player[a].inputs.a[0]&&!player[a].inputs.a[1]||player[a].inputs.b[0]&&!player[a].inputs.b[1]?(aS[65].init(a),!0):!1}},{name:"DOWNSTANDN",canEdgeCancel:!0,init:function(a){player[a].actionState=62;player[a].timer=0;aS[62].main(a)},main:function(a){player[a].timer++;aS[62].interrupt(a)||(reduceByTraction(a,
!0),1==player[a].timer&&(player[a].phys.intangibleTimer=22))},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNSTANDB",canEdgeCancel:!1,setVelocities:[-.185,-.37,-.573,-1.54,-1.614,-1.586,-1.566,-1.614,-1.647,-1.666,-1.669,-1.657,-1.63,-1.588,-1.531,-1.397,-1.224,-1.094,-1.006,-.962,-.96,-.926,-.816,-.684,-.529,-.352,-.226,-.171,-.124,-.084,-.051,-.025,-.007,.004,.008],init:function(a){player[a].actionState=63;player[a].timer=0;aS[63].main(a)},main:function(a){player[a].timer++;
aS[63].interrupt(a)||(player[a].phys.cVel.x=aS[63].setVelocities[player[a].timer-1]*player[a].phys.face,1==player[a].timer&&(player[a].phys.intangibleTimer=19))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNSTANDF",canEdgeCancel:!1,setVelocities:[.467,1.36,1.733,2.135,2.355,2.581,2.055,2.281,2.184,1.902,1.703,1.521,1.357,1.211,1.082,.971,.878,.802,.743,.703,.68,.674,.686,.716,.763,.775,.727,.661,.577,.474,.352,.241,.163,.101,.055],init:function(a){player[a].actionState=
64;player[a].timer=0;aS[64].main(a)},main:function(a){player[a].timer++;aS[64].interrupt(a)||(player[a].phys.cVel.x=aS[64].setVelocities[player[a].timer-1]*player[a].phys.face,6==player[a].timer&&(player[a].phys.intangibleTimer=14))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNATTACK",canEdgeCancel:!1,init:function(a){player[a].actionState=65;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.downattack1.id0;player[a].hitboxes.id1=
player[a].charHitboxes.downattack1.id1;player[a].hitboxes.id2=player[a].charHitboxes.downattack1.id2;player[a].hitboxes.id3=player[a].charHitboxes.downattack1.id3;aS[65].main(a)},main:function(a){player[a].timer++;aS[65].interrupt(a)||(reduceByTraction(a,!0),1==player[a].timer&&(player[a].phys.intangibleTimer=31),20==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword2")),20<player[a].timer&&24>player[a].timer&&player[a].hitboxes.frame++,24==player[a].timer&&
turnOffHitboxes(a),30==player[a].timer&&(player[a].hitboxes.id0=player[a].charHitboxes.downattack2.id0,player[a].hitboxes.id1=player[a].charHitboxes.downattack2.id1,player[a].hitboxes.id2=player[a].charHitboxes.downattack2.id2,player[a].hitboxes.id3=player[a].charHitboxes.downattack2.id3,player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,playSfx("sword2")),30<player[a].timer&&32>player[a].timer&&player[a].hitboxes.frame++,32==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 49<
player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHN",canEdgeCancel:!0,init:function(a){player[a].actionState=66;player[a].timer=0;drawVfx("tech",player[a].phys.pos);playSfx("tech");aS[66].main(a)},main:function(a){player[a].timer++;aS[66].interrupt(a)||(reduceByTraction(a,!0),1==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 26<player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHB",canEdgeCancel:!1,setVelocities:[0,0,0,0,0,0,0,-2.832,-2.726,-2.622,-2.521,-2.422,
-2.326,-2.233,-2.142,-2.054,-1.968,-1.885,-1.811,-1.748,-1.691,-1.639,-1.593,-1.553,-1.519,-1.49,-1.467,-1.45,-1.439,-1.433,-1.433,-.002,-.003,-.004,-.005,-.006,-.006,-.007,-.007,-.006],init:function(a){player[a].actionState=67;player[a].timer=0;drawVfx("tech",player[a].phys.pos);playSfx("tech");aS[67].main(a)},main:function(a){player[a].timer++;aS[67].interrupt(a)||(1==player[a].timer&&(player[a].phys.intangibleTimer=20),player[a].phys.cVel.x=aS[67].setVelocities[player[a].timer-1]*player[a].phys.face)},
interrupt:function(a){return 40<player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHF",canEdgeCancel:!1,setVelocities:[0,0,0,0,0,0,0,4.036,3.526,2.726,2.317,1.862,1.656,1.625,1.768,1.989,2.094,2.083,1.956,1.846,1.814,1.757,1.676,1.57,1.44,1.286,1.107,.949,.834,.727,.629,.54,.459,.387,.323,.268,.222,.184,.155,.135],init:function(a){player[a].actionState=68;player[a].timer=0;drawVfx("tech",player[a].phys.pos);playSfx("tech");aS[68].main(a)},main:function(a){player[a].timer++;aS[68].interrupt(a)||(1==
player[a].timer&&(player[a].phys.intangibleTimer=20),player[a].phys.cVel.x=aS[68].setVelocities[player[a].timer-1]*player[a].phys.face)},interrupt:function(a){return 40<player[a].timer?(aS[0].init(a),!0):!1}},{name:"SHIELDBREAKFALL",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=69;player[a].timer=0;aS[69].main(a)},main:function(a){player[a].timer++;aS[69].interrupt(a)||(player[a].phys.intangibleTimer=1,player[a].phys.cVel.y-=player[a].charAttributes.gravity)},
interrupt:function(a){return 30<player[a].timer?(aS[69].init(a),!0):!1}},{name:"SHIELDBREAKDOWNBOUND",canEdgeCancel:!0,init:function(a){player[a].actionState=70;player[a].timer=0;player[a].phys.cVel.y=0;player[a].phys.kVel.y=0;drawVfx("groundBounce",player[a].phys.pos,player[a].phys.face);playSfx("bounce");aS[70].main(a)},main:function(a){player[a].timer++;aS[70].interrupt(a)||(player[a].phys.intangibleTimer=1,1==player[a].timer?reduceByTraction(a,!0):player[a].phys.cVel.x=0)},interrupt:function(a){return 26<
player[a].timer?(aS[71].init(a),!0):!1}},{name:"SHIELDBREAKSTAND",canEdgeCancel:!0,init:function(a){player[a].actionState=71;player[a].timer=0;aS[71].main(a)},main:function(a){player[a].timer++;aS[71].interrupt(a)||(reduceByTraction(a,!0),player[a].phys.intangibleTimer=1)},interrupt:function(a){return 30<player[a].timer?(aS[72].init(a),!0):!1}},{name:"FURAFURA",canEdgeCancel:!0,init:function(a){player[a].actionState=72;player[a].timer=0;player[a].phys.stuckTimer=490;drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+
(4+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+11+3*Math.random()),player[a].phys.face);playSfx("furaloop");aS[72].main(a)},main:function(a){player[a].timer++;aS[72].interrupt(a)||(65==player[a].timer%100&&playSfx("furacry"),reduceByTraction(a,!0),0==player[a].timer%49&&drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+(3+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+11+3*Math.random()),player[a].phys.face),20==player[a].timer%49&&drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+
(5+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+8+3*Math.random()),player[a].phys.face),30<player[a].phys.shieldHP&&(player[a].phys.shieldHP=30),player[a].phys.stuckTimer--,mashOut(a)&&(player[a].phys.stuckTimer-=3))},interrupt:function(a){return 0>=player[a].phys.stuckTimer?(sounds.furaloop.stop(),aS[0].init(a),!0):!1}},{name:"GRAB",canEdgeCancel:!1,init:function(a){player[a].actionState=73;player[a].timer=0;player[a].phys.charging=!1;player[a].phys.chargeFrames=0;turnOffHitboxes(a);
player[a].hitboxes.id0=player[a].charHitboxes.grab.id0;player[a].hitboxes.id1=player[a].charHitboxes.grab.id1;player[a].hitboxes.id2=player[a].charHitboxes.grab.id2;aS[73].main(a)},main:function(a){player[a].timer++;aS[73].interrupt(a)||(reduceByTraction(a,!0),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!1],player[a].hitboxes.frame=0,playSfx("grab")),7<player[a].timer&&9>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 30<
player[a].timer?(aS[0].init(a),!0):!1}},{name:"CAPTUREPULLED",canEdgeCancel:!1,init:function(a){player[a].actionState=74;player[a].timer=0;player[a].phys.grounded=!0;player[a].phys.face=-1*player[player[a].phys.grabbedBy].phys.face;player[a].phys.onSurface=player[player[a].phys.grabbedBy].phys.onSurface;player[a].phys.stuckTimer=100+2*player[a].percent;playSfx("grabbed");aS[74].main(a)},main:function(a){player[a].timer++;aS[74].interrupt(a)||2!=player[a].timer||(player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x+
-16.41205*player[a].phys.face,player[player[a].phys.grabbedBy].phys.pos.y))},interrupt:function(a){return 2<player[a].timer?(aS[75].init(a),aS[76].init(player[a].phys.grabbedBy),drawVfx("tech",new Vec2D(player[a].phys.pos.x,player[a].phys.pos.y+10)),!0):!1}},{name:"CAPTUREWAIT",canEdgeCancel:!1,init:function(a){player[a].actionState=75;player[a].timer=0;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x+-9.04298*player[a].phys.face,player[player[a].phys.grabbedBy].phys.pos.y);
aS[75].main(a)},main:function(a){player[a].timer++;aS[75].interrupt(a)||(player[a].phys.stuckTimer--,mashOut(a)?(player[a].phys.stuckTimer-=3,player[a].phys.pos.x+=.5*Math.sign(Math.random()-.5)):player[a].phys.pos.x=player[player[a].phys.grabbedBy].phys.pos.x+-9.04298*player[a].phys.face)},interrupt:function(a){return 0>player[a].phys.stuckTimer?(aS[78].init(player[a].phys.grabbedBy),aS[77].init(a),!0):1<player[a].timer?(aS[75].init(a),!0):!1}},{name:"CATCHWAIT",canEdgeCancel:!1,init:function(a){player[a].actionState=
...
player[a].phys.face&&-.7<player[a].inputs.lStickAxis[1].x*player[a].phys.face||-.7>player[a].inputs.cStickAxis[0].x*player[a].phys.face?(aS[85].init(a),!0):.7<player[a].inputs.lStickAxis[0].x*player[a].phys.face&&.7>player[a].inputs.lStickAxis[1].x*player[a].phys.face||.7<player[a].inputs.cStickAxis[0].x*player[a].phys.face?(aS[87].init(a),!0):1<player[a].timer?(aS[76].init(a),!0):!1}},{name:"CAPTURECUT",canEdgeCancel:!1,canGrabLedge:[!0,!1],wallJumpAble:!1,init:function(a){player[a].actionState=
77;player[a].timer=0;player[a].phys.grabbedBy=-1;player[a].phys.cVel.x=-1*player[a].phys.face;aS[77].main(a)},main:function(a){player[a].timer++;aS[77].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"CATCHCUT",canEdgeCancel:!1,canGrabLedge:[!0,!1],init:function(a){player[a].actionState=78;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.cVel.x=-1*player[a].phys.face;aS[78].main(a)},main:function(a){player[a].timer++;aS[78].interrupt(a)||
...
player[a].timer?(aS[76].init(a),!0):!1}},{name:"CAPTUREDAMAGE",canEdgeCancel:!1,setPositions:[9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.306,8.92,8.516,8.29,8.293,8.41,8.593,8.792,8.959,9.043,9.068],init:function(a){player[a].actionState=80;player[a].timer=0;aS[80].main(a)},main:function(a){player[a].timer++;aS[80].interrupt(a)||(player[a].phys.pos.x=player[player[a].phys.grabbedBy].phys.pos.x+-aS[80].setPositions[player[a].timer-1]*player[a].phys.face)},interrupt:function(a){return 20<
player[a].timer?(aS[75].init(a),!0):!1}},{name:"THROWUP",canEdgeCancel:!1,init:function(a){player[a].actionState=81;player[a].timer=0;aS[82].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwup.id0;randomShout();aS[81].main(a)},main:function(a){player[a].timer++;aS[81].interrupt(a)||11!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,!1]),turnOffHitboxes(a))},interrupt:function(a){return 39<player[a].timer?(player[a].phys.grabbing=
-1,aS[0].init(a),!0):11>player[a].timer&&player[player[a].phys.grabbing].phys.grabbedBy!=a?(console.log("test"),aS[78].init(a),!0):!1}},{name:"THROWNUP",canEdgeCancel:!1,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=82;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,player[player[a].phys.grabbedBy].phys.pos.y);aS[82].main(a)},main:function(a){player[a].timer++;aS[82].interrupt(a)},interrupt:function(a){return!1}},
{name:"THROWDOWN",canEdgeCancel:!1,init:function(a){player[a].actionState=83;player[a].timer=0;aS[84].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwdown.id0;randomShout();aS[83].main(a)},main:function(a){player[a].timer++;aS[83].interrupt(a)||13!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,!0]),turnOffHitboxes(a))},interrupt:function(a){return 37<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):13>player[a].timer&&
player[player[a].phys.grabbing].phys.grabbedBy!=a?(console.log("test"),aS[78].init(a),!0):!1}},{name:"THROWNDOWN",canEdgeCancel:!1,reverseModel:!0,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=84;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.face*=-1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,player[player[a].phys.grabbedBy].phys.pos.y);aS[84].main(a)},main:function(a){player[a].timer++;aS[84].interrupt(a)},interrupt:function(a){return!1}},
{name:"THROWBACK",canEdgeCancel:!1,init:function(a){player[a].actionState=85;player[a].timer=0;aS[86].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwback.id0;randomShout();aS[85].main(a)},main:function(a){player[a].timer++;aS[85].interrupt(a)||7!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,!0]),turnOffHitboxes(a))},interrupt:function(a){return 39<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):7>player[a].timer&&
player[player[a].phys.grabbing].phys.grabbedBy!=a?(aS[78].init(a),!0):!1}},{name:"THROWNBACK",canEdgeCancel:!1,reverseModel:!0,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=86;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.face*=-1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,player[player[a].phys.grabbedBy].phys.pos.y);aS[86].main(a)},main:function(a){player[a].timer++;aS[86].interrupt(a)},interrupt:function(a){return!1}},
{name:"THROWFORWARD",canEdgeCancel:!1,init:function(a){player[a].actionState=87;player[a].timer=0;aS[88].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwforward.id0;randomShout();aS[87].main(a)},main:function(a){player[a].timer++;aS[87].interrupt(a)||13!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,!0]),turnOffHitboxes(a))},interrupt:function(a){return 27<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):13>player[a].timer&&
player[player[a].phys.grabbing].phys.grabbedBy!=a?(aS[78].init(a),!0):!1}},{name:"THROWNFORWARD",canEdgeCancel:!1,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=88;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,player[player[a].phys.grabbedBy].phys.pos.y);aS[88].main(a)},main:function(a){player[a].timer++;aS[88].interrupt(a)},interrupt:function(a){return!1}},{name:"WALLDAMAGE",canPassThrough:!1,
canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=89;player[a].timer=0;playSfx("bounce");aS[89].main(a)},main:function(a){player[a].timer++;0==player[a].hit.hitstun%10&&drawVfx("flyingDust",player[a].phys.pos);2==player[a].timer&&(player[a].phys.kVel.y*=.8,player[a].phys.kVel.x*=-.8,player[a].phys.kDec.x*=-1);aS[89].interrupt(a)||(player[a].hit.hitstun--,player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=
-player[a].charAttributes.terminalV))},interrupt:function(a){return 50<player[a].timer?(aS[40].init(a),!0):!1}},{name:"WALLTECH",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=90;player[a].timer=0;player[a].hit.hitstun=0;player[a].phys.kVel.y=0;player[a].phys.kVel.x=0;player[a].phys.cVel.x=0;player[a].phys.intangibleTimer=10;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[90].main(a)},main:function(a){1>
player[a].timer?(player[a].timer+=.15,1<player[a].timer&&(player[a].timer=1)):player[a].timer++;aS[90].interrupt(a)||(2==player[a].timer&&playSfx("walljump"),.89<player[a].timer&&.91>player[a].timer&&(player[a].phys.cVel.x=.5*player[a].phys.face),1<=player[a].timer&&(fastfall(a),airDrift(a)))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),
!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):26<player[a].timer?(aS[13].init(a),!0):!1}},{name:"WALLJUMP",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=91;player[a].timer=0;player[a].hit.hitstun=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.intangibleTimer=
10;player[a].phys.cVel.x=1.3*player[a].phys.face;player[a].phys.cVel.y=2.4;player[a].hit.hitlag=5;player[a].hit.knockback=0;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[91].main(a)},main:function(a){player[a].timer++;aS[91].interrupt(a)||(2==player[a].timer&&playSfx("walljump"),fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||
player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):40<player[a].timer?(aS[13].init(a),!0):!1}},{name:"WALLTECHJUMP",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=92;player[a].timer=0;player[a].hit.hitstun=
0;player[a].phys.kVel.y=0;player[a].phys.kVel.x=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.intangibleTimer=10;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[92].main(a)},main:function(a){1>player[a].timer?(player[a].timer+=.15,1<player[a].timer&&(player[a].timer=1)):player[a].timer++;aS[90].interrupt(a)||(2==player[a].timer&&playSfx("walljump"),.89<player[a].timer&&.91>player[a].timer&&(player[a].phys.cVel.x=1.3*player[a].phys.face,
player[a].phys.cVel.y=2.4),1<=player[a].timer&&(fastfall(a),airDrift(a)))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1]||.7<player[a].inputs.lStickAxis[0].y&&.7>=player[a].inputs.lStickAxis[1].y)&&!player[a].phys.doubleJumped?(aS[19].init(a),
!0):d[0]?(aS[d[1]].init(a),!0):40<player[a].timer?(aS[13].init(a),!0):!1}},{name:"SLEEP",init:function(a){player[a].actionState=93;player[a].timer=0;player[a].hit.hitstun=0;player[a].phys.kVel.y=0;player[a].phys.kVel.x=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.pos.x=300;aS[93].main(a)},main:function(a){},interrupt:function(a){return!1}},{name:"ENTRANCE",init:function(a){player[a].actionState=94;player[a].timer=0;player[a].phys.grounded=!1;aS[94].main(a)},main:function(a){player[a].timer++;
aS[94].interrupt(a)},interrupt:function(a){60<player[a].timer&&aS[13].init(a)}},{name:"CLIFFGETUPQUICK",offset:[[-71.33,-23.71],[-71.38,-23.71],[-71.42,-23.71],[-71.45,-23.71],[-71.46,-23.71],[-71.44,-23.71],[-71.38,-23.71],[-71.26,-23.71],[-71.07,-22.69],[-70.8,-19.99],[-70.47,-16.19],[-70.11,-11.83],[-69.71,-7.48],[-69.28,-3.68],[-68.83,-1.01],[-67.88,0],[-67.38,0],[-66.87,0],[-66.35,0],[-65.81,0],[-65.27,0],[-64.73,0],[-64.19,0],[-63.65,0],[-63.12,0],[-62.59,0],[-62.08,0],[-61.6,0],[-61.17,0],
[-60.8,0],[-60.5,0],[-60.28,0]],init:function(a){player[a].actionState=95;player[a].timer=0;player[a].phys.intangibleTimer=30;aS[95].main(a)},main:function(a){player[a].timer++;aS[95].interrupt(a)||(16>player[a].timer?player[a].phys.pos=new Vec2D(aS[95].offset[player[a].timer-1][0]*player[a].phys.face,aS[95].offset[player[a].timer-1][1]):player[a].phys.pos.x=aS[95].offset[player[a].timer-1][0]*player[a].phys.face,16==player[a].timer&&(player[a].phys.grounded=!0,player[a].phys.onSurface=-1,player[a].phys.airborneTimer=
0,player[a].phys.pos.y=0))},interrupt:function(a){return 32<player[a].timer?(player[a].phys.onLedge=-1,player[a].phys.ledgeRegrabCount=!0,aS[0].init(a),!0):!1}}];twoPi=2*Math.PI;function drawArrayPath(a,b,d,e,f,n,q){for(var h=0;h<f.length;h++){var m=f[h][0]*n*b+d,g=f[h][1]*q+e;0==h?(c.fillStyle=a,c.beginPath(),c.moveTo(m,g)):c.lineTo(m,g)}c.closePath();c.fill()}
function renderPlayer(a){var b=4.5*player[a].phys.pos.x+600,d=-4.5*player[a].phys.pos.y+480,e=player[a].phys.face,f=Math.floor(player[a].timer);0==f&&(f=1);var n=animations[charSelect[a]][aS[player[a].actionState].name][f-1];switch(player[a].actionState){case 15:case 17:case 20:case 25:case 61:case 72:case 94:n=animations[charSelect[a]][aS[player[a].actionState].name][0]}aS[player[a].actionState].reverseModel?e*=-1:4==player[a].actionState?5<f&&(e*=-1):6==player[a].actionState?18<f&&(e*=-1):34==player[a].actionState&&
29<f&&(e*=-1);if(player[a].phys.shielding){var q=4.5*player[a].phys.shieldPositionReal.x+600,h=-4.5*player[a].phys.shieldPositionReal.y+480,m=palettes[pPal[a]][2];0<Math.floor(player[a].hit.shieldstun)&&(m=palettes[pPal[a]][4]);c.fillStyle=m+.6*player[a].phys.shieldAnalog+")";c.beginPath();c.arc(q,h,4.5*player[a].phys.shieldSize,twoPi,0);c.fill()}if(26>player[a].actionState||29<player[a].actionState){q=3<player[a].phys.intangibleTimer%9||3<player[a].phys.invincibleTimer%9||0<player[a].hit.hitlag?
...
new Vec2D(50,600*-g+375),player[a].miniViewSide=1),player[a].miniView=!0):-600<=375/g&&600>=375/g?(player[a].miniViewPoint=h.y>m.y?50>b?new Vec2D(50,700):1150<b?new Vec2D(1150,700):new Vec2D(b,700):new Vec2D(-375/g+600,50),player[a].miniViewSide=2,player[a].miniView=!0):player[a].miniView=!1}else player[a].miniView=!1;player[a].miniView&&93!=player[a].actionState?(c.fillStyle="black",c.strokeStyle=palettes[pPal[a]][0],c.beginPath(),c.arc(player[a].miniViewPoint.x,player[a].miniViewPoint.y,35,twoPi,
0),c.fill(),c.lineWidth=6,c.stroke(),c.lineWidth=1,drawArrayPath(q,e,player[a].miniViewPoint.x,player[a].miniViewPoint.y+30,n,.14,.14)):94==player[a].actionState?drawArrayPath(q,e,b,d,n,.2,Math.min(.2,.2*(1.5-startTimer))):drawArrayPath(q,e,b,d,n,.2,.2)}hasTag[a]&&(c.fillStyle="rgba(0,0,0,0.5)",c.strokeStyle=palettes[pPal[a]][0],e=10*tagText[a].length,c.fillRect(b-e/2,d-130,e,20),c.strokeRect(b-e/2,d-130,e,20),c.font="13px Lucida Console, monaco, monospace",c.textAlign="center",c.fillStyle="white",
...
function menuMove(a){var b=!1,d=menuSelected;if(player[a].inputs.a[0]&&!player[a].inputs.a[1])playSfx("menuForward"),0==menuSelected&&(gameMode=2);else if(!player[a].inputs.b[0])if(.7<player[a].inputs.lStickAxis[0].y)stickHoldEach[a]=!0,0==stickHold?(menuSelected--,b=!0,stickHold++):(stickHold++,0==stickHold%10&&(menuSelected--,b=!0));else if(-.7>player[a].inputs.lStickAxis[0].y)stickHoldEach[a]=!0,0==stickHold?(menuSelected++,b=!0,stickHold++):(stickHold++,0==stickHold%10&&(menuSelected++,b=!0));
else if(stickHoldEach[a]=!1,a==ports-1){a=!1;for(var e=0;e<ports;e++)if(stickHoldEach[e]){a=!0;break}a||(stickHold=0)}b&&(menuTimer=menuCycle=0,playSfx("menuSelect"),-1==menuSelected&&(menuSelected=2),3==menuSelected&&(menuSelected=0),3==d+menuSelected?1==menuSelected?menuColours[menuSelected]=0:menuCurColour=0:1==d&&(menuCurColour=358,menuColours[1]=358),menuColourOffset=menuColours[menuSelected]-menuCurColour)}menuAngle=menuColourOffset=0;
...
function cssControls(a){if(-1==choosingTag){player[a].inputs.b[0]?(bHold[a]++,60==bHold[a]&&(playSfx("menuBack"),gameMode=1)):bHold[a]=0;handPos[a].x+=12*player[a].inputs.lStickAxis[0].x;handPos[a].y+=12*-player[a].inputs.lStickAxis[0].y;1200<handPos[a].x?handPos[a].x=1200:0>handPos[a].x&&(handPos[a].x=0);750<handPos[a].y?handPos[a].y=750:0>handPos[a].y&&(handPos[a].y=0);if(400>handPos[a].y&&130<handPos[a].y)if(handType[a]=1,player[a].inputs.b[0]&&!player[a].inputs.b[1]&&0==playerType[a]&&(handType[a]=
...
playerType[a]&&(handType[a]=2,tokenPos[a]=new Vec2D(handPos[a].x,handPos[a].y),tokenGrabbed[a]=!0);else{handType[a]=0;tokenPos[a]=new Vec2D(568+a%2*40,268+(1<a?40:0));tokenGrabbed[a]=!1;for(var b=0;4>b;b++)430<handPos[a].y&&485>handPos[a].y&&handPos[a].x>109+225*b&&handPos[a].x<207+225*b&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(playSfx("menuSelect"),togglePort(b),hasTag[b]=!1)}130>handPos[a].y&&900<handPos[a].x&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(playSfx("menuBack"),gameMode=
1);player[a].inputs.x[0]&&!player[a].inputs.x[1]&&(playSfx("menuSelect"),pPal[a]++,6<pPal[a]&&(pPal[a]=0));player[a].inputs.y[0]&&!player[a].inputs.y[1]&&(playSfx("menuSelect"),pPal[a]--,0>pPal[a]&&(pPal[a]=6));640<handPos[a].y&&680>handPos[a].y&&handPos[a].x>130+225*a&&handPos[a].x<310+225*a&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(handPos[a].x<154+225*a?(playSfx("menuSelect"),hasTag[a]=!0,tagText[a]=randomTags[Math.round((randomTags.length-1)*Math.random())]):handPos[a].x>286+225*a?(playSfx("menuSelect"),
hasTag[a]=!1):(playSfx("menuSelect"),hasTag[a]=!0,choosingTag=a,c.fillStyle="rgba(0,0,0,0.8)",c.fillRect(0,0,canvas.width,canvas.height),$("#pTagEdit"+a).show().select()))}else choosingTag==a&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(playSfx("menuSelect"),tagText[choosingTag]=$("#pTagEdit"+choosingTag).val(),$("#pTagEdit"+choosingTag).hide(),choosingTag=-1);readyToFight&&-1==choosingTag&&pause[a][0]&&!pause[a][1]&&(playSfx("menuForward"),startGame())}
...
function customDeadzone(){this.ls=new Vec2D(0,0);this.cs=new Vec2D(0,0);this.r=this.l=0}keyboardMap=[102,101,100,104,103,105,107,109,71,78,66,86];keyboardOccupied=!1;map={a:[1,0,4],b:[2,1,3],x:[0,2,2],y:[3,3,1],z:[7,4,7],r:[5,5,6],l:[4,6,5],s:[9,7,0],du:[12,8,8],dr:[13,11,10],dd:[14,9,9],dl:[15,10,11],lsX:[0,0,0],lsY:[1,1,1],csX:[5,3,3],csY:[2,4,4],lA:[3,2,5],rA:[4,5,6]};console.log("raphnet update!");mType=[0,0,0,0];cd=[new customDeadzone,new customDeadzone,new customDeadzone,new customDeadzone];
currentPlayers=[];playerAmount=0;playerType=[-1,-1,-1,-1];ports=0;activePorts=[];frameByFrame=playing=!1;showVfx=findingPlayers=!0;showDebug=!1;gameMode=0;charSelect=["marth","marth","marth","marth"];randomTags="NEO! SELF NOVA PNDA Panda LFFN Scorp AZ AXE Tempo TMPO [A]rmada WBALLZ Westballz PPMD Kreygasm M2K Mang0 USA SCAR TOPH (.Y.) HBOX HungryBox PLUP Shroomed SFAT Wizz Lucky S2J SilentWolf aMSa S2J Hax$".split(" ");vfxQueue=[];
...
function findPlayers(){var a=navigator.getGamepads();keyboardOccupied||(2>gameMode?keys[109]&&4>ports&&(gameMode=1,keyboardOccupied=!0,playSfx("menuForward"),sounds.menu2.play("menu2Start"),addPlayer(ports,4)):keys[101]&&4>ports&&(keyboardOccupied=!0,addPlayer(ports,4)));for(var b=0;b<a.length;b++){var d=navigator.getGamepads()[b];if("undefined"!=typeof d){var e=0;"v"==d.id[0]||"1"==d.id[0]?e=1:"M"==d.id[0]||"G"!=d.id[0]&&"2"!=d.id[0]||(e=2,console.log("You are using raphnet"));if(2>gameMode){if(d.buttons[map.s[e]].pressed){for(var d=
!1,f=0;f<ports;f++)currentPlayers[f]==b&&(d=!0);!d&&4>ports&&(gameMode=1,playSfx("menuForward"),sounds.menu2.play("menu2Start"),addPlayer(b,e))}}else if(d.buttons[map.a[e]].pressed){d=!1;for(f=0;f<ports;f++)currentPlayers[f]==b&&(d=!0);d||4>ports&&addPlayer(b,e)}}}}function addPlayer(a,b){ports++;currentPlayers[ports-1]=a;playerType[ports-1]=0;mType[ports-1]=b}function togglePort(a){playerType[a]++;2==playerType[a]&&(playerType[a]=-1);0==playerType[a]&&ports<=a&&(playerType[a]=1)}
function interpretInputs(a,b){if(4==mType[a]){var d=keys[68]?keys[65]?0:1:keys[65]?-1:0,e=keys[87]?keys[83]?0:1:keys[83]?-1:0;if(keys[32]||keys[16])d*=.7,e*=.7;var f=keys[39]?keys[37]?0:1:keys[37]?-1:0,n=keys[38]?keys[40]?0:1:keys[40]?-1:0,q=0,h=0}else{var m=navigator.getGamepads()[currentPlayers[a]],d=m.axes[map.lsX[mType[a]]]-cd[a].ls.x,e=-1*m.axes[map.lsY[mType[a]]]-cd[a].ls.y,d=d/.75,e=e/.75,d=1<d?1:-1>d?-1:Math.round(80*d)/80,e=1<e?1:-1>e?-1:Math.round(80*e)/80;.3>Math.abs(d)&&(d=0);.3>Math.abs(e)&&
(e=0);n=-1*m.axes[map.csY[mType[a]]]-cd[a].cs.y;f=m.axes[map.csX[mType[a]]]-cd[a].cs.x;f/=.75;n/=.75;f=1<f?1:-1>f?-1:Math.round(80*f)/80;n=1<n?1:-1>n?-1:Math.round(80*n)/80;.3>Math.abs(f)&&(f=0);.3>Math.abs(n)&&(n=0);q=m.axes[map.lA[mType[a]]]-cd[a].l;h=m.axes[map.rA[mType[a]]]-cd[a].r;2==mType[a]&&(q*=-1,h*=-1);q+=.9;h+=.9;1<q&&(q=1);1<h&&(h=1);.3>q&&(q=0);.3>h&&(h=0)}pause[a][1]=pause[a][0];frameAdvance[a][1]=frameAdvance[a][0];4==mType[a]?(pause[a][0]=keys[109]?!0:!1,frameAdvance[a][0]=keys[107]?
!0:!1):(pause[a][0]=m.buttons[map.s[mType[a]]].pressed?!0:!1,frameAdvance[a][0]=m.buttons[map.z[mType[a]]].pressed?!0:!1);if(b){for(var g=0;7>g;g++)player[a].inputs.lStickAxis[7-g].x=player[a].inputs.lStickAxis[6-g].x,player[a].inputs.lStickAxis[7-g].y=player[a].inputs.lStickAxis[6-g].y,player[a].inputs.cStickAxis[7-g].x=player[a].inputs.cStickAxis[6-g].x,player[a].inputs.cStickAxis[7-g].y=player[a].inputs.cStickAxis[6-g].y,player[a].inputs.lAnalog[7-g]=player[a].inputs.lAnalog[6-g],player[a].inputs.rAnalog[7-
g]=player[a].inputs.rAnalog[6-g],player[a].inputs.z[7-g]=player[a].inputs.z[6-g],player[a].inputs.a[7-g]=player[a].inputs.a[6-g],player[a].inputs.b[7-g]=player[a].inputs.b[6-g],player[a].inputs.x[7-g]=player[a].inputs.x[6-g],player[a].inputs.y[7-g]=player[a].inputs.y[6-g],player[a].inputs.r[7-g]=player[a].inputs.r[6-g],player[a].inputs.l[7-g]=player[a].inputs.l[6-g],player[a].inputs.dpadleft[7-g]=player[a].inputs.dpadleft[6-g],player[a].inputs.dpaddown[7-g]=player[a].inputs.dpaddown[6-g],player[a].inputs.dpadright[7-
g]=player[a].inputs.dpadright[6-g],player[a].inputs.dpadup[7-g]=player[a].inputs.dpadup[6-g];player[a].inputs.lStickAxis[0].x=d;player[a].inputs.lStickAxis[0].y=e;player[a].inputs.cStickAxis[0].x=f;player[a].inputs.cStickAxis[0].y=n;player[a].inputs.lAnalog[0]=q;player[a].inputs.rAnalog[0]=h;4==mType[a]?(player[a].inputs.x[0]=keys[102],player[a].inputs.a[0]=keys[101],player[a].inputs.b[0]=keys[100],player[a].inputs.y[0]=keys[104],player[a].inputs.r[0]=keys[105],player[a].inputs.l[0]=keys[103],player[a].inputs.dpadleft[0]=
keys[86],player[a].inputs.dpaddown[0]=keys[66],player[a].inputs.dpadright[0]=keys[78],player[a].inputs.dpadup[0]=keys[71]):(player[a].inputs.x[0]=m.buttons[map.x[mType[a]]].pressed,player[a].inputs.a[0]=m.buttons[map.a[mType[a]]].pressed,player[a].inputs.b[0]=m.buttons[map.b[mType[a]]].pressed,player[a].inputs.y[0]=m.buttons[map.y[mType[a]]].pressed,player[a].inputs.r[0]=m.buttons[map.r[mType[a]]].pressed,player[a].inputs.l[0]=m.buttons[map.l[mType[a]]].pressed,player[a].inputs.dpadleft[0]=m.buttons[map.dl[mType[a]]].pressed,
player[a].inputs.dpaddown[0]=m.buttons[map.dd[mType[a]]].pressed,player[a].inputs.dpadright[0]=m.buttons[map.dr[mType[a]]].pressed,player[a].inputs.dpadup[0]=m.buttons[map.du[mType[a]]].pressed);frameByFrame||(player[a].inputs.z[0]=4==mType[a]?keys[107]:m.buttons[map.z[mType[a]]].pressed,player[a].inputs.z[0]&&(player[a].inputs.lAnalog[0]=.35,player[a].inputs.a[0]=!0));player[a].inputs.l[0]&&(player[a].inputs.lAnalog[0]=1);player[a].inputs.r[0]&&(player[a].inputs.rAnalog[0]=1)}else 4==mType[a]?keys[101]&&
keys[103]&&keys[105]&&keys[109]&&(keys[100]?startGame():endGame()):m.buttons[map.a[mType[a]]].pressed&&m.buttons[map.l[mType[a]]].pressed&&m.buttons[map.r[mType[a]]].pressed&&m.buttons[map.s[mType[a]]].pressed&&(m.buttons[map.b[mType[a]]].pressed?startGame():endGame()),frameAdvance[a][0]&&!frameAdvance[a][1]&&(frameByFrame=!0);player[a].inputs.dpadleft[0]&&!player[a].inputs.dpadleft[1]&&(player[a].showLedgeGrabBox^=1);player[a].inputs.dpaddown[0]&&!player[a].inputs.dpaddown[1]&&(player[a].showECB^=
1);player[a].inputs.dpadright[0]&&!player[a].inputs.dpadright[1]&&(player[a].showHitbox^=1);4!=mType[a]&&m.buttons[map.du[mType[a]]].pressed&&m.buttons[map.x[mType[a]]].pressed&&m.buttons[map.y[mType[a]]].pressed&&!attemptingControllerReset[a]&&(attemptingControllerReset[a]=!0,setTimeout(function(){m.buttons[map.du[mType[a]]].pressed&&m.buttons[map.x[mType[a]]].pressed&&m.buttons[map.y[mType[a]]].pressed&&(cd[a].ls=new Vec2D(m.axes[0],-1*m.axes[1]),cd[a].cs=new Vec2D(m.axes[5],-1*m.axes[2]),cd[a].l=
m.axes[3]+.8,cd[a].r=m.axes[4]+.8,$("#resetIndicator"+a).fadeIn(100),$("#resetIndicator"+a).fadeOut(500));attemptingControllerReset[a]=!1},2E3));pause[a][0]&&!pause[a][1]&&3==gameMode&&((playing^=1)||renderForeground());0<player[a].phys.lCancelTimer&&(player[a].phys.lCancelTimer--,0==player[a].phys.lCancelTimer&&(player[a].phys.lCancel=!1));0==player[a].phys.lCancelTimer&&(0<player[a].inputs.lAnalog[0]&&0==player[a].inputs.lAnalog[1]||0<player[a].inputs.rAnalog[0]&&0==player[a].inputs.lAnalog[1]||
player[a].inputs.z[0]&&!player[a].inputs.z[1])&&(player[a].phys.lCancelTimer=7,player[a].phys.lCancel=!0);$("#lsAxisX"+a).empty().append(d.toFixed(5));$("#lsAxisY"+a).empty().append(e.toFixed(5));$("#lAnalog"+a).empty().append(q.toFixed(5));$("#rAnalog"+a).empty().append(h.toFixed(5));if(4==mType[a])for(g=0;12>g;g++)keys[keyboardMap[g]]?$("#"+a+"button"+g).show():$("#"+a+"button"+g).hide();else for(g=0;12>g;g++)d=g,0==mType[a]&&(5<d&&d++,7<d&&d++,8<d&&(d+=2)),m.buttons[d].pressed?$("#"+a+"button"+
g).show():$("#"+a+"button"+g).hide()}
...
var e=d=-1;if(-1==player[a].phys.onLedge&&!player[a].phys.ledgeRegrabCount)for(b=0;b<edges.length;b++){for(var f=!0,n=0;4>n;n++)-1<playerType[n]&&n!=a&&player[n].phys.onLedge==b&&(f=!1);f&&(edges[b][0][0]>player[a].phys.ledgeSnapBoxF.min.x&&edges[b][0][0]<player[a].phys.ledgeSnapBoxF.max.x&&edges[b][0][1]<player[a].phys.ledgeSnapBoxF.min.y&&edges[b][0][1]>player[a].phys.ledgeSnapBoxF.max.y&&aS[player[a].actionState].canGrabLedge[0]&&(d=b),edges[b][0][0]>player[a].phys.ledgeSnapBoxB.min.x&&edges[b][0][0]<
...
function startGame(){gameMode=3;vfxQueue=[];$("#playerFind").hide();$("#matchTimer").show();$("#matchMinutes").empty().append("8");$("#matchSeconds").empty().append("00.00");$(".percentContainer").css("color","white");for(var a=0;4>a;a++)-1<playerType[a]&&(initializePlayers(a),renderPlayer(a),player[a].inCSS=!1);matchTimer=480;startTimer=1.5;starting=!0;sounds.menu2.stop();sounds.battlefield.stop();sounds.battlefield.play("battlefieldStart");drawVfx("start",new Vec2D(0,0));findingPlayers=!1;playing=
!0}
function endGame(){sounds.battlefield.stop();$("#matchTimer").hide();playing=!1;c.fillStyle="rgba(0, 0, 0, 1)";c.fillRect(-100,-100,canvas.width+200,canvas.height+200);drawStage();$(".stockPercent").hide();gameMode=2;sounds.menu2.play("menu2Start");pause=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];frameAdvance=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];findingPlayers=!0;for(var a=0;4>a;a++)-1<playerType[a]&&(player[a].inputs.a[0]=!0,player[a].inputs.a[1]=!0,player[a].inCSS=!0,player[a].phys.face=1,player[a].actionState=0)}
function finishGame(){playSfx("game");playing=!1;var a=c.createLinearGradient(0,200,0,500);a.addColorStop(0,"black");a.addColorStop(.4,"black");a.addColorStop(1,"rgb(255, 31, 52)");c.save();c.textAlign="start";c.fillStyle=a;c.lineWidth=40;c.strokeStyle="black";c.font="900 300px Arial";c.strokeText("Game!",100,470);c.lineWidth=20;c.strokeStyle="white";c.font="900 300px Arial";c.strokeText("Game!",100,470);c.font="900 300px Arial";c.fillText("Game!",100,470);c.restore();sounds.battlefield.stop();setTimeout(function(){endGame()},
2500)}
$(document).ready(function(){$(".stockPercent").hide();$("#keyboardButton").click(function(){$("#keyboardControlsImg").toggle()});canvas=document.getElementById("gameCanvas");c=canvas.getContext("2d");c.fillStyle="rgba(0, 0, 0, 1)";c.fillRect(-100,-100,canvas.width+200,canvas.height+200);drawStartScreen();gameTick();renderTick();var a=Math.max(($(window).width()-1200)/2,0),b=Math.max(($(window).height()-750)/2,0);$("#display").css("margin",b+"px 0px 0px "+a+"px");$("#effectsButton").click(function(){showVfx?$("#effectsButtonEdit").empty().append("OFF"):
$("#effectsButtonEdit").empty().append("ON");showVfx^=1});$("#debugButton").click(function(){if(showDebug){$("#debugButtonEdit").empty().append("OFF");$("#debug").hide();$("#players").hide();var b=Math.max(($(window).height()-750)/2,0);$("#display").css("margin",b+"px 0px 0px "+a+"px")}else $("#debugButtonEdit").empty().append("ON"),$("#debug").show(),$("#players").show(),b=Math.max(($(window).height()-900)/2,0),$("#display").css("margin",b+" 0px 0px px "+a+"px");showDebug^=1})});
