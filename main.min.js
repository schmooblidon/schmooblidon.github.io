...
Math.PI),c.closePath(),c.stroke(),c.beginPath(),c.arc(0,0,23,1.35*Math.PI,1.65*Math.PI),c.closePath(),c.fill();c.restore()},start:function(a){if(90>vfxQueue[a][1]){var b=c.createLinearGradient(0,200,0,500);b.addColorStop(0,"rgb(255, 51, 51)");b.addColorStop(.6,"rgb(255, 51, 51)");b.addColorStop(1,"rgb(121, 0, 0)");c.save();c.fillStyle=b;c.lineWidth=20;c.strokeStyle="black";c.font="italic 900 200px Arial";c.strokeText("Ready",240,420);c.lineWidth=10;c.strokeStyle="white";c.strokeText("Ready",240,420);
c.fillText("Ready",240,420);c.fillStyle="rgb("+Math.round(2.6*vfxQueue[a][1])+","+Math.round(140-1.5*vfxQueue[a][1])+","+Math.round(255-2.6*vfxQueue[a][1])+")";c.font="italic 700 70px Arial";b=(2*startTimer%1).toFixed(2);c.strokeStyle="black";c.strokeText(Math.floor(2*startTimer)+" "+b[2]+b[3],900,500);c.fillText(Math.floor(2*startTimer)+" "+b[2]+b[3],900,500);c.fillStyle="rgba(255,0,0,0.2)";c.fillRect(240,450,520,15);b=c.createLinearGradient(240+vfxQueue[a][1]/90*500,450,760+vfxQueue[a][1]/90*500,
465);b.addColorStop(0,"#ff0000");b.addColorStop(.16,"#ff00ff");b.addColorStop(.33,"#0000ff");b.addColorStop(.49,"#00ffff");b.addColorStop(.66,"#00ff00");b.addColorStop(.83,"#ffff00");b.addColorStop(1,"#ff0000");c.fillStyle=b;c.fillRect(240+vfxQueue[a][1]/90*500,450,520-vfxQueue[a][1]/90*500,15)}else b=c.createLinearGradient(0,200,0,480),b.addColorStop(0,"black"),b.addColorStop(.6,"black"),b.addColorStop(1,"rgb(221, 145, 57)"),c.save(),c.fillStyle=b,c.lineWidth=40,c.strokeStyle="black",c.font="900 400px Arial",
c.strokeText("Go!",240,470),c.lineWidth=20,c.strokeStyle="white",c.strokeText("Go!",240,470),c.fillText("Go!",240,470);c.restore()},entrance:function(a){c.save();c.translate(4.5*vfxQueue[a][2].x+600,-4.5*vfxQueue[a][2].y+480);for(var b=0,d=vfxQueue[a][1]*Math.PI/32,e=0;8>e;e++){var f=Math.random()-.5,b=new Vec2D(35*Math.cos(d),14*Math.sin(d)),k=c.createLinearGradient(0,0,0,2*-vfxQueue[a][1]-60*f);k.addColorStop(0,"rgba(255, 255, 255, 0.3)");k.addColorStop(.5,"rgba(255, 255, 255, 0.3)");k.addColorStop(1,
"rgba(255, 255, 255, 0.0)");c.fillStyle=k;c.fillRect(b.x,b.y-(2*vfxQueue[a][1]+60*f),10,2*vfxQueue[a][1]+60*f);d+=Math.PI/4}c.fillStyle="rgba(163, 255, 203, 0.3)";c.fillRect(-35,5*-(vfxQueue[a][1]%15),80,15);c.restore();c.save();c.translate(4.5*vfxQueue[a][2].x+600,-4.5*vfxQueue[a][2].y+480);c.strokeStyle="rgba(255, 149, 149, 0.8)";c.lineWidth=8;c.scale(.8+.3*Math.random(),.2+.2*Math.random());c.beginPath();c.arc(5,3*-vfxQueue[a][1],35+vfxQueue[a][1]%2*10,0,twoPi);c.closePath();c.stroke();c.restore()}};
hitQueue=[];angleConversion=Math.PI/180;
...
function isFinalDeath(){for(var a=0,b=0;b<playerAmount;b++)0==player[b].stocks&&a++;return a>=playerAmount-1}function getAngle(a,b){var d=0;if(0!=a||0!=b)d=Math.atan2(b,a);return d}function turnOffHitboxes(a){player[a].hitboxes.active=[!1,!1,!1,!1];player[a].hitboxes.hitList=[]}
...
0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,90);isFinalDeath()||(screenShake(500),percentShake(500,a));aS[26].main(a)},main:function(a){player[a].timer++;aS[26].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),percentShake(500,a)))},interrupt:function(a){return 60<player[a].timer?(0<player[a].stocks?aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADRIGHT",
init:function(a){player[a].actionState=27;player[a].timer=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,-90);isFinalDeath()||(screenShake(500),percentShake(500,a));aS[27].main(a)},main:function(a){player[a].timer++;aS[27].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),percentShake(500,a)))},interrupt:function(a){return 60<player[a].timer?(0<player[a].stocks?
aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADUP",init:function(a){player[a].actionState=28;player[a].timer=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,180);isFinalDeath()||(screenShake(500),percentShake(500,a));aS[28].main(a)},main:function(a){player[a].timer++;aS[28].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),percentShake(500,a)))},interrupt:function(a){return 60<
player[a].timer?(0<player[a].stocks?aS[30].init(a):aS[93].init(a),!0):!1}},{name:"DEADDOWN",init:function(a){player[a].actionState=29;player[a].timer=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.kVel.x=0;player[a].phys.kVel.y=0;player[a].percent=0;drawVfx("blastzoneExplosion",player[a].phys.pos,0);isFinalDeath()||(screenShake(500),percentShake(500,a));aS[29].main(a)},main:function(a){player[a].timer++;aS[29].interrupt(a)||4!=player[a].timer||(isFinalDeath()?finishGame():(screenShake(500),
...
(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):10<player[a].timer?(aS[32].init(a),!0):!1}},{name:"ATTACKAIRF",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=33;player[a].timer=0;player[a].phys.autoCancel=!1;player[a].inAerial=!0;player[a].hitboxes.id0=player[a].charHitboxes.fair.id0;player[a].hitboxes.id1=player[a].charHitboxes.fair.id1;
player[a].hitboxes.id2=player[a].charHitboxes.fair.id2;player[a].hitboxes.id3=player[a].charHitboxes.fair.id3;turnOffHitboxes(a);aS[33].main(a)},main:function(a){player[a].timer++;aS[33].interrupt(a)||(fastfall(a),airDrift(a),2<player[a].timer&&11>player[a].timer&&drawVfx("swingFair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-3),4==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=
...
canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=34;player[a].timer=0;player[a].phys.autoCancel=!1;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.bair.id0;player[a].hitboxes.id1=player[a].charHitboxes.bair.id1;player[a].hitboxes.id2=player[a].charHitboxes.bair.id2;player[a].hitboxes.id3=player[a].charHitboxes.bair.id3;aS[34].main(a)},main:function(a){player[a].timer++;aS[34].interrupt(a)||(30==player[a].timer&&(player[a].phys.face*=
-1),fastfall(a),airDrift(a),2<player[a].timer&&12>player[a].timer&&drawVfx("swingBair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-3),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),7<player[a].timer&&12>player[a].timer&&player[a].hitboxes.frame++,12==player[a].timer&&turnOffHitboxes(a),32==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){if(39<player[a].timer)return aS[13].init(a),
!0;if(34<player[a].timer){var b=checkForAerials(a);if((player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped)return aS[19].init(a),!0;if(b[0])return aS[b[1]].init(a),!0}return!1}},{name:"ATTACKAIRU",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=35;player[a].timer=0;player[a].phys.autoCancel=!0;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.upair.id0;
...
player[a].hitboxes.id0=player[a].charHitboxes.dair.id0;player[a].hitboxes.id1=player[a].charHitboxes.dair.id1;player[a].hitboxes.id2=player[a].charHitboxes.dair.id2;player[a].hitboxes.id3=player[a].charHitboxes.dair.id3;aS[36].main(a)},main:function(a){player[a].timer++;aS[36].interrupt(a)||(fastfall(a),airDrift(a),4<player[a].timer&&12>player[a].timer&&drawVfx("swingDair",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-
5),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,player[a].phys.autoCancel=!1),6<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a),48==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){return 59<player[a].timer?(aS[13].init(a),!0):!1}},{name:"ATTACKAIRN",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=37;player[a].timer=0;player[a].phys.autoCancel=
!0;player[a].inAerial=!0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.nair1.id0;player[a].hitboxes.id1=player[a].charHitboxes.nair1.id1;player[a].hitboxes.id2=player[a].charHitboxes.nair1.id2;player[a].hitboxes.id3=player[a].charHitboxes.nair1.id3;aS[37].main(a)},main:function(a){player[a].timer++;aS[37].interrupt(a)||(fastfall(a),airDrift(a),4<player[a].timer&&9>player[a].timer&&drawVfx("swingNair1",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),
player[a].phys.face,player[a].timer-5),13<player[a].timer&&18>player[a].timer&&drawVfx("swingNair2",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-14),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0,player[a].phys.autoCancel=!1),7==player[a].timer&&player[a].hitboxes.frame++,8==player[a].timer&&turnOffHitboxes(a),15==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],
player[a].hitboxes.id0=player[a].charHitboxes.nair2.id0,player[a].hitboxes.id1=player[a].charHitboxes.nair2.id1,player[a].hitboxes.id2=player[a].charHitboxes.nair2.id2,player[a].hitboxes.id3=player[a].charHitboxes.nair2.id3,player[a].hitboxes.frame=0),15<player[a].timer&&22>player[a].timer&&player[a].hitboxes.frame++,22==player[a].timer&&turnOffHitboxes(a),25==player[a].timer&&(player[a].phys.autoCancel=!0))},interrupt:function(a){return 49<player[a].timer?(aS[13].init(a),!0):!1}},{name:"UPSPECIAL",
canPassThrough:!0,canGrabLedge:[!0,!1],setVelocities:[[.75685,14.41555],[.7145,15.51062],[.67334,8.65633],[.63338,2.42162],[.59462,2.11897],[.55706,1.83569],[.52069,1.57181],[.48552,1.32731],[.45155,1.10218],[.41878,.89645],[.3872,.7101],[.35682,.54314],[.32765,.39556],[.29966,.26735],[.27288,.15855],[.24729,.06912],[.2229,-9.3E-4]],wallJumpAble:!1,init:function(a){player[a].actionState=38;player[a].timer=0;player[a].phys.cVel=new Vec2D(0,0);player[a].phys.grounded=!1;player[a].phys.fastfalled=!1;
player[a].phys.upbAngleMultiplier=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.upb1.id0;player[a].hitboxes.id1=player[a].charHitboxes.upb1.id1;player[a].hitboxes.id2=player[a].charHitboxes.upb1.id2;aS[38].main(a)},main:function(a){player[a].timer++;aS[38].interrupt(a)||(0>=player[a].phys.cVel.y&&(player[a].phys.canWallJump=!0),6>player[a].timer&&.7<Math.abs(player[a].inputs.lStickAxis[0].x)&&(player[a].phys.upbAngleMultiplier=-player[a].inputs.lStickAxis[0].x*Math.PI/16),6==
player[a].timer&&-.7>player[a].inputs.lStickAxis[0].x*player[a].phys.face&&(player[a].phys.face*=-1),5<player[a].timer&&23>player[a].timer?player[a].phys.cVel=new Vec2D(aS[38].setVelocities[player[a].timer-6][0]*player[a].phys.face*Math.cos(player[a].phys.upbAngleMultiplier)-aS[38].setVelocities[player[a].timer-6][1]*Math.sin(player[a].phys.upbAngleMultiplier),aS[38].setVelocities[player[a].timer-6][0]*player[a].phys.face*Math.sin(player[a].phys.upbAngleMultiplier)+aS[38].setVelocities[player[a].timer-
6][1]*Math.cos(player[a].phys.upbAngleMultiplier)):22<player[a].timer&&(fastfall(a),airDrift(a)),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!1],player[a].hitboxes.frame=0),6==player[a].timer&&(player[a].hitboxes.id0=player[a].charHitboxes.upb2.id0,player[a].hitboxes.id1=player[a].charHitboxes.upb2.id1,player[a].hitboxes.id2=player[a].charHitboxes.upb2.id2),6<player[a].timer&&11>player[a].timer&&player[a].hitboxes.frame++,11==player[a].timer&&turnOffHitboxes(a),2<player[a].timer&&12>
player[a].timer&&drawVfx("swingUpb",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-3))},interrupt:function(a){return 39<player[a].timer?(aS[14].init(a),!0):!1}},{name:"DAMAGEFLYN",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a,b){player[a].actionState=39;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.grabbedBy=-1;turnOffHitboxes(a);b&&(drawVfx("hitSparks",player[a].hit.hitPoint,
player[a].phys.face),drawVfx("hitFlair",player[a].hit.hitPoint,player[a].phys.face),drawVfx("hitCurve",player[a].hit.hitPoint,player[a].phys.face,player[a].hit.angle));aS[39].main(a)},main:function(a){29>player[a].timer&&player[a].timer++;0==player[a].hit.hitstun%10&&drawVfx("flyingDust",player[a].phys.pos);!aS[39].interrupt(a)&&1<player[a].timer&&(player[a].hit.hitstun--,player[a].phys.grounded||(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&
(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){return 1<player[a].timer&&0==player[a].hit.hitstun?(aS[40].init(a),!0):!1}},{name:"DAMAGEFALL",canPassThrough:!1,canGrabLedge:[!0,!1],wallJumpAble:!1,init:function(a){player[a].actionState=40;player[a].timer=0;aS[40].main(a)},main:function(a){player[a].timer++;aS[40].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&
!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):.7<player[a].inputs.lStickAxis[0].x&&.7>player[a].inputs.lStickAxis[1].x||-.7>player[a].inputs.lStickAxis[0].x&&-.7<player[a].inputs.lStickAxis[1].x||.7<player[a].inputs.lStickAxis[0].y&&.7>player[a].inputs.lStickAxis[1].y||-.7>player[a].inputs.lStickAxis[0].y&&
-.7<player[a].inputs.lStickAxis[1].y?(aS[13].init(a),!0):30<player[a].timer?(aS[40].init(a),!0):!1}},{name:"DAMAGEN2",canEdgeCancel:!0,canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=41;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.grabbedBy=-1;turnOffHitboxes(a);drawVfx("hitSparks",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitFlair",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitCurve",player[a].hit.hitPoint,player[a].phys.face,
player[a].hit.angle);aS[41].main(a)},main:function(a){player[a].timer++;!aS[41].interrupt(a)&&1<player[a].timer&&(player[a].hit.hitstun--,player[a].phys.grounded?reduceByTraction(a,!1):(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){if(23<player[a].timer)return player[a].phys.grounded?aS[0].init(a):aS[13].init(a),!0;if(0>=player[a].hit.hitstun){if(player[a].phys.grounded){var b=
checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);return checkForJump(a)?(aS[8].init(a),!0):player[a].inputs.l[0]||player[a].inputs.r[0]||0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0]?(aS[21].init(a),!0):b[0]?(aS[b[1]].init(a),!0):e[0]?(aS[e[1]].init(a),!0):d[0]?(aS[d[1]].init(a),!0):checkForSquat(a)?(aS[16].init(a),!0):checkForDash(a)?(aS[1].init(a),!0):checkForSmashTurn(a)?(aS[3].init(a),!0):checkForTiltTurn(a)?(player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),
!0):.3<Math.abs(player[a].inputs.lStickAxis[0].x)?(aS[7].init(a,!0),!0):!1}d=checkForAerials(a);b=checkForSpecials(a);if(d[0])return aS[d[1]].init(a),!0;if(player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1])return aS[11].init(a),!0;if((player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped)return aS[19].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(.7<player[a].inputs.lStickAxis[0].x&&
...
player[a].hitboxes.frame++,8==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(19<player[a].timer&&player[a].phys.jabCombo)return aS[51].init(a),!0;if(27<player[a].timer)return aS[0].init(a),!0;if(26<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),
!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"JAB2",canEdgeCancel:!1,init:function(a){player[a].actionState=51;player[a].timer=0;player[a].phys.jabCombo=!1;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.jab2.id0;player[a].hitboxes.id1=player[a].charHitboxes.jab2.id1;player[a].hitboxes.id2=player[a].charHitboxes.jab2.id2;player[a].hitboxes.id3=
player[a].charHitboxes.jab2.id3;aS[51].main(a)},main:function(a){player[a].timer++;aS[51].interrupt(a)||(reduceByTraction(a,!0),1<player[a].timer&&26>player[a].timer&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(player[a].phys.jabCombo=!0),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),5<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(19<player[a].timer&&player[a].phys.jabCombo)return aS[50].init(a),
!0;if(28<player[a].timer)return aS[0].init(a),!0;if(27<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,
...
1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,aS[0].init(a),!0):!1}},{name:"ESCAPEF",setVelocities:[2.267,2.536,2.706,2.78,2.758,2.64,2.426,2.116,1.711,1.209,.888,.819,.758,.707,.664,.631,.606,.591,.585,.587,.599,.62,.809,1.072,1.205,1.207,1.078,.819,.617,.556,.487,.413,.332,.245,.152],canEdgeCancel:!1,reverseModel:!0,init:function(a){player[a].actionState=53;player[a].timer=0;player[a].phys.shielding=
!1;aS[53].main(a)},main:function(a){player[a].timer++;aS[53].interrupt(a)||(player[a].phys.cVel.x=aS[53].setVelocities[player[a].timer-1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,player[a].phys.face*=-1,aS[0].init(a),!0):!1}},{name:"ESCAPEN",canEdgeCancel:!1,init:function(a){player[a].actionState=54;player[a].timer=0;player[a].phys.shielding=!1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);
aS[54].main(a)},main:function(a){player[a].timer++;aS[54].interrupt(a)||(reduceByTraction(a,!0),2==player[a].timer&&(player[a].phys.intangibleTimer=16))},interrupt:function(a){return 27<player[a].timer?(aS[0].init(a),!0):!1}},{name:"ATTACKDASH",canEdgeCancel:!1,setVelocities:[.755,1.962,2.714,3.01,2.849,2.232,1.184,.542,.704,1.325,1.487,1.079,.666,.631,.597,.565,.536,.508,.482,.458,.436,.416,.398,.37,.332,.299,.27,.244,.222,.205,.191,.181,.176,.165,.148,.13,.112,.093,.073,.053,.032,.011,-.783,-.783,
0,0,.001,.001,0],init:function(a){player[a].actionState=55;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dashattack.id0;player[a].hitboxes.id1=player[a].charHitboxes.dashattack.id1;player[a].hitboxes.id2=player[a].charHitboxes.dashattack.id2;player[a].hitboxes.id3=player[a].charHitboxes.dashattack.id3;aS[55].main(a)},main:function(a){player[a].timer++;aS[55].interrupt(a)||(player[a].phys.cVel.x=aS[55].setVelocities[player[a].timer-1]*player[a].phys.face,12==player[a].timer&&
...
player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),20<player[a].timer&&23>player[a].timer&&player[a].hitboxes.frame++,23==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(64<player[a].timer)return aS[0].init(a),!0;if(61<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),
...
0),c.fill(),c.lineWidth=6,c.stroke(),c.lineWidth=1,drawArrayPath(l,e,player[a].miniViewPoint.x,player[a].miniViewPoint.y+30,k,.14,.14)):94==player[a].actionState?drawArrayPath(l,e,b,d,k,.2,Math.min(.2,.2*(1.5-startTimer))):drawArrayPath(l,e,b,d,k,.2,.2)}hasTag[a]&&(c.fillStyle="rgba(0,0,0,0.5)",c.strokeStyle=palettes[pPal[a]][0],e=10*tagText[a].length,c.fillRect(b-e/2,d-130,e,20),c.strokeRect(b-e/2,d-130,e,20),c.font="13px Lucida Console, monaco, monospace",c.textAlign="center",c.fillStyle="white",
...
c.fillText("B",32,70);c.fillText("Z",-872,-583);c.font="800 17px Arial";c.fillText("T",170,9);c.scale(1.2,1);c.font="900 24px Arial";c.fillText("RESET",72,43);c.fillText("L",17,7);c.fillText("R",56,7);c.fillText("A",93,9);c.font="900 20px Arial";c.fillText("RUNBACK",53,70);c.font="900 18px Arial";c.fillText("FRAME ADVANCE",-685,-584);c.restore()}player=[0,0,0,0];renderTime=[10,0,100,0];gamelogicTime=[5,0,100,0];framerate=[0,0,0];attemptingControllerReset=[!1,!1,!1,!1];
function customDeadzone(){this.ls=new Vec2D(0,0);this.cs=new Vec2D(0,0);this.r=this.l=0}map={a:[1,0],b:[2,1],x:[0,2],y:[3,3],z:[7,4],r:[5,5],l:[4,6],s:[9,7],du:[12,8],dr:[13,11],dd:[14,9],dl:[15,10],lsX:[0,0],lsY:[1,1],csX:[5,3],csY:[2,4],lA:[3,2],rA:[4,5]};mType=[0,0,0,0];cd=[new customDeadzone,new customDeadzone,new customDeadzone,new customDeadzone];currentPlayers=[];playerAmount=0;frameByFrame=playing=!1;showVfx=findingPlayers=!0;showDebug=!1;charSelect=["marth","marth","marth","marth"];
...
palettes=[["rgba(250, 89, 89, 0.6)","rgba(255, 170, 170, 0.6)","rgba(255, 206, 111, ","rgba(244, 68, 68, 0.6)","rgba(255, 225, 167, "],["rgba(4, 255, 134, 0.6)","rgba(154, 254, 170, 0.6)","rgba(252, 95, 95, ","rgba(255, 182, 96, 0.6)","rgba(254, 141, 141, "],["rgba(5, 195, 255, 0.6)","rgba(121, 223, 255, 0.6)","rgba(218, 96, 254, ","rgba(231, 134, 255, 0.6)","rgba(230, 144, 255, "],["rgba(255, 187, 70, 0.74)","rgba(248, 255, 122, 0.6)","rgba(80, 182, 255, ","rgba(255, 142, 70, 0.6)","rgba(139, 203, 249, "],
["rgba(177, 89, 255, 0.6)","rgba(203, 144, 255, 0.6)","rgba(144, 255, 110, ","rgba(247, 126, 250, 0.6)","rgba(190, 255, 170, "],["rgba(182, 131, 70, 0.6)","rgba(252, 194, 126, 0.6)","rgba(47, 186, 123, ","rgba(255, 112, 66, 0.6)","rgba(111, 214, 168, "],["rgba(166, 166, 166, 0.6)","rgba(255, 255, 255, 0.6)","rgba(255, 255, 255, ","rgba(191, 119, 119, 0.6)","rgba(175, 172, 172, "]];hurtboxColours=["rgba(255, 237, 70, 0.6)","rgba(42, 57, 255, 0.6)","rgba(54, 255, 37, 0.6)"];hasTag=[!1,!1,!1,!1];
tagText=["","","",""];pPal=[];costumeTimeout=[];colours=["rgba(4, 255, 82, 0.62)","rgba(117, 20, 255, 0.63)","rgba(255, 20, 20, 0.63)","rgba(255, 232, 20, 0.63)"];pause=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];frameAdvance=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];startingPoint=[[-50,50],[50,50],[-25,5],[25,5]];startingFace=[1,-1,1,-1];ground=[[-68.4,0],[68.4,0]];platforms=[[[-57.6,27.2],[-20,27.2]],[[20,27.2],[57.6,27.2]],[[-18.8,54.4],[18.8,54.4]]];wallsL=[[[-68.4,0],[-68.4,-108.8]]];wallsR=[[[68.4,0],[68.4,-108.8]]];
...
function findPlayers(){for(var a=navigator.getGamepads(),b=0;b<a.length;b++){var d=navigator.getGamepads()[b];if("undefined"!=typeof d){var e=0;"v"==d.id[0]||"1"==d.id[0]?(e=1,console.log("You are using vJoy")):"M"==d.id[0]&&console.log("You are using Mayflash");if(d.buttons[map.a[e]].pressed){for(var f=!1,k=0;k<playerAmount;k++)currentPlayers[k]==b&&(f=!0);f||4>playerAmount&&addPlayer(b,e)}for(e=0;e<currentPlayers.length;e++)currentPlayers[e]==b&&(!d.buttons[map.x[mType[e]]].pressed&&!d.buttons[map.y[mType[e]]].pressed||
...
4>playerAmount&&addPlayer(-1),zPress[e]=!0):zPress[e]=!1,pause[e][1]=pause[e][0],pause[e][0]=d.buttons[map.s[mType[e]]].pressed,pause[e][0]&&!pause[e][1]&&startGame())}}}
...
function interpretInputs(a,b){var d=navigator.getGamepads()[currentPlayers[a]],e=d.axes[map.lsX[mType[a]]]-cd[a].ls.x,f=-1*d.axes[map.lsY[mType[a]]]-cd[a].ls.y,e=e/.75,f=f/.75,e=1<e?1:-1>e?-1:Math.round(80*e)/80,f=1<f?1:-1>f?-1:Math.round(80*f)/80;.3>Math.abs(e)&&(e=0);.3>Math.abs(f)&&(f=0);var k=-1*d.axes[map.csY[mType[a]]]-cd[a].cs.y,l=d.axes[map.csX[mType[a]]]-cd[a].cs.x,l=l/.75,k=k/.75,l=1<l?1:-1>l?-1:Math.round(80*l)/80,k=1<k?1:-1>k?-1:Math.round(80*k)/80;.3>Math.abs(l)&&(l=0);.3>Math.abs(k)&&
(k=0);var h=d.axes[map.lA[mType[a]]]-cd[a].l,m=d.axes[map.rA[mType[a]]]-cd[a].r,h=h+.9,m=m+.9;1<h&&(h=1);1<m&&(m=1);.3>h&&(h=0);.3>m&&(m=0);pause[a][1]=pause[a][0];frameAdvance[a][1]=frameAdvance[a][0];pause[a][0]=d.buttons[map.s[mType[a]]].pressed?!0:!1;frameAdvance[a][0]=d.buttons[map.z[mType[a]]].pressed?!0:!1;if(b){for(var g=0;7>g;g++)player[a].inputs.lStickAxis[7-g].x=player[a].inputs.lStickAxis[6-g].x,player[a].inputs.lStickAxis[7-g].y=player[a].inputs.lStickAxis[6-g].y,player[a].inputs.cStickAxis[7-
...
!0,setTimeout(function(){d.buttons[map.du[mType[a]]].pressed&&d.buttons[map.x[mType[a]]].pressed&&d.buttons[map.y[mType[a]]].pressed&&(cd[a].ls=new Vec2D(d.axes[0],-1*d.axes[1]),cd[a].cs=new Vec2D(d.axes[5],-1*d.axes[2]),cd[a].l=d.axes[3]+.8,cd[a].r=d.axes[4]+.8,$("#resetIndicator"+a).fadeIn(100),$("#resetIndicator"+a).fadeOut(500));attemptingControllerReset[a]=!1},2E3));pause[a][0]&&!pause[a][1]&&((playing^=1)||renderForeground());0<player[a].phys.lCancelTimer&&(player[a].phys.lCancelTimer--,0==
player[a].phys.lCancelTimer&&(player[a].phys.lCancel=!1));0==player[a].phys.lCancelTimer&&(0<player[a].inputs.lAnalog[0]&&0==player[a].inputs.lAnalog[1]||0<player[a].inputs.rAnalog[0]&&0==player[a].inputs.lAnalog[1]||player[a].inputs.z[0]&&!player[a].inputs.z[1])&&(player[a].phys.lCancelTimer=7,player[a].phys.lCancel=!0);$("#lsAxisX"+a).empty().append(e.toFixed(5));$("#lsAxisY"+a).empty().append(f.toFixed(5));$("#lAnalog"+a).empty().append(h.toFixed(5));$("#rAnalog"+a).empty().append(m.toFixed(5));
...
39&&(d[0]=!1,player[a].phys.pos.x-=player[a].phys.ECBp[1].x-wallsL[b][1][0],39==player[a].actionState?(player[a].phys.face=-1,0<player[a].phys.techTimer?player[a].inputs.x[0]||player[a].inputs.y[0]||.7<player[a].inputs.lStickAxis[0].y?aS[92].init(a):aS[90].init(a):(drawVfx("wallBounce",new Vec2D(wallsL[b][1][0],player[a].phys.ECBp[1].y),-1,0),aS[89].init(a))):player[a].phys.canWallJump&&(254==player[a].phys.wallJumpTimer&&.5<=player[a].phys.posDelta.x&&(player[a].phys.wallJumpTimer=0),0<=player[a].phys.wallJumpTimer&&
120>player[a].phys.wallJumpTimer&&(-.7>=player[a].inputs.lStickAxis[0].x&&0<=player[a].inputs.lStickAxis[3].x?(player[a].phys.wallJumpTimer=254,player[a].phys.face=-1,aS[91].init(a)):player[a].phys.wallJumpTimer++)));for(b=0;b<wallsR.length;b++)player[a].phys.ECBp[3].y<wallsR[b][0][1]&&player[a].phys.ECBp[3].y>wallsR[b][1][1]&&player[a].phys.ECBp[3].x<=wallsR[b][1][0]&&player[a].phys.ECBp[3].x>wallsR[b][1][0]-39&&(d[1]=!1,player[a].phys.pos.x-=player[a].phys.ECBp[3].x-wallsR[b][1][0],39==player[a].actionState?
(player[a].phys.face=1,0<player[a].phys.techTimer?player[a].inputs.x[0]||player[a].inputs.y[0]||.7<player[a].inputs.lStickAxis[0].y?aS[92].init(a):aS[90].init(a):(drawVfx("wallBounce",new Vec2D(wallsR[b][1][0],player[a].phys.ECBp[3].y),1,1),aS[89].init(a))):player[a].phys.canWallJump&&(254==player[a].phys.wallJumpTimer&&.5<=player[a].phys.posDelta.x&&(player[a].phys.wallJumpTimer=0),0<=player[a].phys.wallJumpTimer&&120>player[a].phys.wallJumpTimer&&(.7<=player[a].inputs.lStickAxis[0].x&&0>=player[a].inputs.lStickAxis[3].x?
(player[a].phys.wallJumpTimer=254,player[a].phys.face=1,aS[91].init(a)):player[a].phys.wallJumpTimer++)));d[0]&&d[1]&&player[a].phys.canWallJump&&(player[a].phys.wallJumpTimer=254);if(player[a].phys.grounded)for(b=0;b<playerAmount;b++)a!=b&&player[b].phys.grounded&&player[b].phys.onSurface==player[a].phys.onSurface&&player[a].phys.grabbing!=b&&player[a].phys.grabbedBy!=b&&(d=Math.abs(player[a].phys.pos.x-player[b].phys.pos.x),6.5>d&&0<d?player[b].phys.pos.x+=-.3*Math.sign(player[a].phys.pos.x-player[b].phys.pos.x):
0==d&&Math.abs(player[a].phys.cVel.x)>Math.abs(player[b].phys.cVel.x)&&(player[b].phys.pos.x+=-.3*Math.sign(player[a].phys.cVel.x)));0==player[a].phys.shielding&&(player[a].phys.shieldHP+=.07,60<player[a].phys.shieldHP&&(player[a].phys.shieldHP=60));b=player[a].phys.pos.x;d=player[a].phys.pos.y;player[a].phys.ECB1=11==player[a].actionState?[new Vec2D(0+b,1+d),new Vec2D(3+b,9+d),new Vec2D(0+b,14+d),new Vec2D(-3+b,9+d)]:24==player[a].actionState?[new Vec2D(0+b,1+d),new Vec2D(2+b,9+d),new Vec2D(0+b,
14+d),new Vec2D(-2+b,9+d)]:player[a].phys.grounded||10>player[a].phys.airborneTimer?[new Vec2D(0+b,0+d),new Vec2D(3+b,7+d),new Vec2D(0+b,14+d),new Vec2D(-3+b,7+d)]:[new Vec2D(0+b,4+d),new Vec2D(3+b,9+d),new Vec2D(0+b,14+d),new Vec2D(-3+b,9+d)];!player[a].phys.grounded&&0>player[a].phys.ECB1[0].y&&player[a].phys.ECB1[0].x>ground[0][0]&&player[a].phys.ECB1[0].x<ground[1][0]&&land(a,0,-1);player[a].phys.hurtbox=new Box2D([-4+b,18+d],[4+b,d]);player[a].phys.ledgeSnapBoxF=new Box2D([player[a].phys.pos.x,
player[a].phys.pos.y+22],[player[a].phys.pos.x+14,player[a].phys.pos.y+12]);player[a].phys.ledgeSnapBoxB=new Box2D([player[a].phys.pos.x-14,player[a].phys.pos.y+22],[player[a].phys.pos.x,player[a].phys.pos.y+12]);player[a].phys.ledgeRegrabCount&&(player[a].phys.ledgeRegrabTimeout--,0==player[a].phys.ledgeRegrabTimeout&&(player[a].phys.ledgeRegrabCount=!1));var e=d=-1;if(-1==player[a].phys.onLedge&&!player[a].phys.ledgeRegrabCount)for(b=0;b<edges.length;b++){for(var f=!0,k=0;k<playerAmount;k++)k!=
a&&player[k].phys.onLedge==b&&(f=!1);f&&(edges[b][0][0]>player[a].phys.ledgeSnapBoxF.min.x&&edges[b][0][0]<player[a].phys.ledgeSnapBoxF.max.x&&edges[b][0][1]<player[a].phys.ledgeSnapBoxF.min.y&&edges[b][0][1]>player[a].phys.ledgeSnapBoxF.max.y&&aS[player[a].actionState].canGrabLedge[0]&&(d=b),edges[b][0][0]>player[a].phys.ledgeSnapBoxB.min.x&&edges[b][0][0]<player[a].phys.ledgeSnapBoxB.max.x&&edges[b][0][1]<player[a].phys.ledgeSnapBoxB.min.y&&edges[b][0][1]>player[a].phys.ledgeSnapBoxF.max.y&&aS[player[a].actionState].canGrabLedge[0]&&
(e=b));0>player[a].phys.cVel.y&&-.5<player[a].inputs.lStickAxis[0].y&&(-1<d&&edgeOrientation[d]==player[a].phys.face?(player[a].phys.onLedge=d,player[a].phys.ledgeRegrabTimeout=30,player[a].phys.face=edgeOrientation[d],player[a].phys.pos=new Vec2D(edgeOffset[d][0],edgeOffset[d][1]),aS[24].init(a)):-1<e&&edgeOrientation[e]==player[a].phys.face&&(player[a].phys.onLedge=e,player[a].phys.ledgeRegrabTimeout=30,player[a].phys.face=edgeOrientation[e],player[a].phys.pos=new Vec2D(edgeOffset[e][0],edgeOffset[e][1]),
aS[24].init(a)))}(26>player[a].actionState||29<player[a].actionState)&&93!=player[a].actionState&&(b=0,player[a].phys.pos.x<blastzone.min.x?b=26:player[a].phys.pos.x>blastzone.max.x?b=27:player[a].phys.pos.y>blastzone.min.y?b=28:player[a].phys.pos.y<blastzone.max.y&&(b=29),0<b&&(player[a].stocks--,aS[b].init(a),-1==player[a].stocks?(player[a].stocks=4,$("."+a+"stock").show()):$("#"+a+"stock"+(player[a].stocks+1)).fadeOut()));hitDetection(a);player[a].phys.posDelta=new Vec2D(Math.abs(player[a].phys.pos.x-
...
function renderVfx(){for(var a=[],b=0;b<vfxQueue.length;b++)if(vfxQueue[b][1]++,vfxQueue[b][0].frames>=vfxQueue[b][1]){if(showVfx)dVfx[vfxQueue[b][0].name](b)}else a.push(b);for(b=0;b<a.length;b++)vfxQueue.splice(a[b]-b,1)}
function drawVfx(a,b,d,e){"undefined"===typeof e&&(e=-1);var f={};$.extend(!0,f,vfx[a]);"circleDust"==f.name&&(f.circles[0]=-2*Math.random(),f.circles[1]=-4.5*Math.random()-2,f.circles[2]=2*Math.random(),f.circles[3]=4.5*Math.random()+2);a=new Vec2D(b.x,b.y);vfxQueue.push([f,0,a,d,e])}function update(a){starting||-1!=currentPlayers[a]&&interpretInputs(a,!0);physics(a)}lastFrameTimeMs=delta=0;lastUpdate=performance.now();
function gameTick(){var a=performance.now(),b=0;if(playing||frameByFrame){lastUpdate=performance.now();hitQueue=[];for(var d=0;d<playerAmount;d++)update(d);executeHits();starting?(startTimer-=.01666667,0>startTimer&&(starting=!1)):matchTimerTick();frameByFrame=!1;b=performance.now()-a;gamelogicTime[0]+=b;gamelogicTime[0]/=2;10<=b&&gamelogicTime[3]++;b<gamelogicTime[2]&&(gamelogicTime[2]=b);b>gamelogicTime[1]&&(gamelogicTime[1]=b);$("#gamelogicAvg").empty().append(Math.round(gamelogicTime[0]));$("#gamelogicHigh").empty().append(Math.round(gamelogicTime[1]));
...
$("#renderLow").empty().append(Math.round(renderTime[2]));$("#renderPeak").empty().append(renderTime[3])}frameByFrame&&renderForeground();window.requestAnimationFrame(renderTick)}
function initializePlayers(a){player[a]=new playerObject(charSelect[a],startingPoint[a],startingFace[a]);hasTag[a]&&(tagText[a]=$("#pTagEdit"+a).val());$("#sP"+a).show().css("display","inline-block");$("."+a+"stock").css("background-color",palettes[pPal[a]][0]);$("."+a+"stock").show();drawVfx("entrance",new Vec2D(startingPoint[a][0],startingPoint[a][1]))}
...
function startGame(){vfxQueue=[];$("#playerFind").hide();$("#matchMinutes").empty().append("8");$("#matchSeconds").empty().append("00.00");for(var a=0;a<playerAmount;a++)initializePlayers(a),renderPlayer(a);matchTimer=480;startTimer=1.5;starting=!0;drawVfx("start",new Vec2D(0,0));findingPlayers=!1;playing=!0}
function endGame(){playing=!1;c.fillStyle="rgba(0, 0, 0, 1)";c.fillRect(-100,-100,canvas.width+200,canvas.height+200);drawStage();$(".stockPercent").hide();$("#playerFind").show();pause=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];frameAdvance=[[!0,!0],[!0,!0],[!0,!0],[!0,!0]];findingPlayers=!0}
function finishGame(){playing=!1;var a=c.createLinearGradient(0,200,0,500);a.addColorStop(0,"black");a.addColorStop(.4,"black");a.addColorStop(1,"rgb(255, 31, 52)");c.save();c.fillStyle=a;c.lineWidth=40;c.strokeStyle="black";c.font="900 300px Arial";c.strokeText("Game!",100,470);c.lineWidth=20;c.strokeStyle="white";c.font="900 300px Arial";c.strokeText("Game!",100,470);c.font="900 300px Arial";c.fillText("Game!",100,470);c.restore();setTimeout(function(){endGame()},2500)}
$(document).ready(function(){$(".stockPercent").hide();canvas=document.getElementById("gameCanvas");c=canvas.getContext("2d");c.fillStyle="rgba(0, 0, 0, 1)";c.fillRect(-100,-100,canvas.width+200,canvas.height+200);drawStage();gameTick();renderTick();var a=Math.max(($(window).width()-1200)/2,0),b=Math.max(($(window).height()-750)/2,0);$("#display").css("margin",b+"px 0px 0px "+a+"px");$("#effectsButton").click(function(){showVfx?$("#effectsButtonEdit").empty().append("OFF"):$("#effectsButtonEdit").empty().append("ON");
