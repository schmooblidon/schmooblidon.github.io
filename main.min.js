...
!0);$("#lsAxisX"+a).empty().append(e.toFixed(5));$("#lsAxisY"+a).empty().append(f.toFixed(5));$("#lAnalog"+a).empty().append(h.toFixed(5));$("#rAnalog"+a).empty().append(m.toFixed(5));e=16;1==mType[a]&&(e=12);for(g=0;g<e;g++)d.buttons[g].pressed?$("#"+a+"button"+g).show():$("#"+a+"button"+g).hide()}
