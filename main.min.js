...
function customDeadzone(){this.ls=new Vec2D(0,0);this.cs=new Vec2D(0,0);this.r=this.l=0}keyboardMap=[102,101,100,104,103,105,107,109,71,78,66,86];keyboardOccupied=!1;map={a:[1,0],b:[2,1],x:[0,2],y:[3,3],z:[7,4],r:[5,5],l:[4,6],s:[9,7],du:[12,8],dr:[13,11],dd:[14,9],dl:[15,10],lsX:[0,0],lsY:[1,1],csX:[5,3],csY:[2,4],lA:[3,2],rA:[4,5]};mType=[0,0,0,0];cd=[new customDeadzone,new customDeadzone,new customDeadzone,new customDeadzone];currentPlayers=[];playerAmount=0;playerType=[-1,-1,-1,-1];ports=0;
activePorts=[];frameByFrame=playing=!1;showVfx=findingPlayers=!0;showDebug=!1;gameMode=0;charSelect=["marth","marth","marth","marth"];randomTags="NEO! SELF NOVA PNDA Panda LFFN Scorp AZ AXE Tempo TMPO [A]rmada WBALLZ Westballz PPMD Kreygasm M2K Mang0 USA SCAR TOPH (.Y.) HBOX HungryBox PLUP Shroomed SFAT Wizz Lucky S2J SilentWolf aMSa S2J Hax$".split(" ");vfxQueue=[];
