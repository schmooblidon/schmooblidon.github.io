...
(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){return 1<player[a].timer&&0==player[a].hit.hitstun?(aS[40].init(a),!0):!1}},{name:"DAMAGEFALL",canPassThrough:!1,canGrabLedge:[!0,!1],wallJumpAble:!1,init:function(a){player[a].actionState=40;player[a].timer=0;aS[40].main(a)},main:function(a){player[a].timer++;aS[40].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){return 30<player[a].timer?(aS[40].init(a),!0):player[a].inputs.x[0]&&!player[a].inputs.x[1]||
player[a].inputs.y[0]&&!player[a].inputs.y[1]?(aS[19].init(a),!0):!1}},{name:"DAMAGEN2",canEdgeCancel:!0,canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=41;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.grabbedBy=-1;turnOffHitboxes(a);drawVfx("hitSparks",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitFlair",player[a].hit.hitPoint,player[a].phys.face);drawVfx("hitCurve",player[a].hit.hitPoint,player[a].phys.face,player[a].hit.angle);
aS[41].main(a)},main:function(a){player[a].timer++;!aS[41].interrupt(a)&&1<player[a].timer&&(player[a].hit.hitstun--,player[a].phys.grounded?reduceByTraction(a,!1):(player[a].phys.cVel.y-=player[a].charAttributes.gravity,player[a].phys.cVel.y<-player[a].charAttributes.terminalV&&(player[a].phys.cVel.y=-player[a].charAttributes.terminalV)))},interrupt:function(a){return 23<player[a].timer?(player[a].phys.grounded?aS[0].init(a):aS[13].init(a),!0):!1}},{name:"LANDINGATTACKAIRN",canEdgeCancel:!0,init:function(a){player[a].actionState=
42;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[42].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;aS[42].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRF",canEdgeCancel:!0,init:function(a){player[a].actionState=43;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?
2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[43].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;aS[43].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRB",canEdgeCancel:!0,init:function(a){player[a].actionState=44;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[44].main(a)},
main:function(a){player[a].timer+=1.25*player[a].phys.landingLagScaling;aS[44].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRD",canEdgeCancel:!0,init:function(a){player[a].actionState=45;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[45].main(a)},main:function(a){player[a].timer+=.9375*player[a].phys.landingLagScaling;
aS[45].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"LANDINGATTACKAIRU",canEdgeCancel:!0,init:function(a){player[a].actionState=46;player[a].timer=0;player[a].phys.landingLagScaling=player[a].phys.lCancel?2:1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[46].main(a)},main:function(a){player[a].timer+=2*player[a].phys.landingLagScaling;aS[46].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<
player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNTILT",canEdgeCancel:!1,init:function(a){player[a].actionState=47;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dtilt.id0;player[a].hitboxes.id1=player[a].charHitboxes.dtilt.id1;player[a].hitboxes.id2=player[a].charHitboxes.dtilt.id2;player[a].hitboxes.id3=player[a].charHitboxes.dtilt.id3;aS[47].main(a)},main:function(a){player[a].timer++;aS[47].interrupt(a)||(reduceByTraction(a,!0),5<player[a].timer&&10>player[a].timer&&
drawVfx("swingDtilt",new Vec2D(player[a].phys.pos.x+player[a].phys.cVel.x,player[a].phys.pos.y+player[a].phys.cVel.y),player[a].phys.face,player[a].timer-6),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),7<player[a].timer&&10>player[a].timer&&player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(49<player[a].timer)return aS[17].init(a),!0;if(19<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);
...
player[a].charHitboxes.ftilt.id2;player[a].hitboxes.id3=player[a].charHitboxes.ftilt.id3;aS[49].main(a)},main:function(a){player[a].timer++;aS[49].interrupt(a)||(reduceByTraction(a,!0),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),7<player[a].timer&&11>player[a].timer&&player[a].hitboxes.frame++,11==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"JAB1",canEdgeCancel:!1,init:function(a){player[a].actionState=
50;player[a].timer=0;player[a].phys.jabCombo=!1;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.jab1.id0;player[a].hitboxes.id1=player[a].charHitboxes.jab1.id1;player[a].hitboxes.id2=player[a].charHitboxes.jab1.id2;player[a].hitboxes.id3=player[a].charHitboxes.jab1.id3;aS[50].main(a)},main:function(a){player[a].timer++;aS[50].interrupt(a)||(reduceByTraction(a,!0),2<player[a].timer&&26>player[a].timer&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(player[a].phys.jabCombo=!0),4==
...
!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"JAB2",canEdgeCancel:!1,init:function(a){player[a].actionState=51;player[a].timer=0;player[a].phys.jabCombo=!1;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.jab2.id0;
player[a].hitboxes.id1=player[a].charHitboxes.jab2.id1;player[a].hitboxes.id2=player[a].charHitboxes.jab2.id2;player[a].hitboxes.id3=player[a].charHitboxes.jab2.id3;aS[51].main(a)},main:function(a){player[a].timer++;aS[51].interrupt(a)||(reduceByTraction(a,!0),1<player[a].timer&&26>player[a].timer&&player[a].inputs.a[0]&&!player[a].inputs.a[1]&&(player[a].phys.jabCombo=!0),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),5<player[a].timer&&10>player[a].timer&&
player[a].hitboxes.frame++,10==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(19<player[a].timer&&player[a].phys.jabCombo)return aS[50].init(a),!0;if(28<player[a].timer)return aS[0].init(a),!0;if(27<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),
!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"ESCAPEB",setVelocities:[-2.267,-2.536,-2.706,-2.78,-2.758,-2.64,-2.426,-2.116,-1.711,-1.209,-.888,-.819,-.758,-.707,-.664,-.631,-.606,-.591,-.585,-.587,-.599,-.62,-.809,-1.072,-1.205,-1.207,-1.078,-.819,-.617,-.556,-.487,-.413,-.332,-.245,-.152],canEdgeCancel:!1,init:function(a){player[a].actionState=52;player[a].timer=
0;player[a].phys.shielding=!1;aS[52].main(a)},main:function(a){player[a].timer++;aS[52].interrupt(a)||(player[a].phys.cVel.x=aS[52].setVelocities[player[a].timer-1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,aS[0].init(a),!0):!1}},{name:"ESCAPEF",setVelocities:[2.267,2.536,2.706,2.78,2.758,2.64,2.426,2.116,1.711,1.209,.888,.819,.758,.707,.664,.631,.606,.591,.585,.587,.599,.62,.809,1.072,1.205,
1.207,1.078,.819,.617,.556,.487,.413,.332,.245,.152],canEdgeCancel:!1,reverseModel:!0,init:function(a){player[a].actionState=53;player[a].timer=0;player[a].phys.shielding=!1;aS[53].main(a)},main:function(a){player[a].timer++;aS[53].interrupt(a)||(player[a].phys.cVel.x=aS[53].setVelocities[player[a].timer-1]*player[a].phys.face,4==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 35<player[a].timer?(player[a].phys.cVel.x=0,player[a].phys.face*=-1,aS[0].init(a),!0):
!1}},{name:"ESCAPEN",canEdgeCancel:!1,init:function(a){player[a].actionState=54;player[a].timer=0;player[a].phys.shielding=!1;drawVfx("circleDust",player[a].phys.pos,player[a].phys.face);aS[54].main(a)},main:function(a){player[a].timer++;aS[54].interrupt(a)||(reduceByTraction(a,!0),2==player[a].timer&&(player[a].phys.intangibleTimer=16))},interrupt:function(a){return 27<player[a].timer?(aS[0].init(a),!0):!1}},{name:"ATTACKDASH",canEdgeCancel:!1,setVelocities:[.755,1.962,2.714,3.01,2.849,2.232,1.184,
.542,.704,1.325,1.487,1.079,.666,.631,.597,.565,.536,.508,.482,.458,.436,.416,.398,.37,.332,.299,.27,.244,.222,.205,.191,.181,.176,.165,.148,.13,.112,.093,.073,.053,.032,.011,-.783,-.783,0,0,.001,.001,0],init:function(a){player[a].actionState=55;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dashattack.id0;player[a].hitboxes.id1=player[a].charHitboxes.dashattack.id1;player[a].hitboxes.id2=player[a].charHitboxes.dashattack.id2;player[a].hitboxes.id3=player[a].charHitboxes.dashattack.id3;
aS[55].main(a)},main:function(a){player[a].timer++;aS[55].interrupt(a)||(player[a].phys.cVel.x=aS[55].setVelocities[player[a].timer-1]*player[a].phys.face,12==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),12<player[a].timer&&16>player[a].timer&&player[a].hitboxes.frame++,16==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(49<player[a].timer)return aS[0].init(a),!0;if(5>player[a].timer&&0<player[a].inputs.lAnalog[0]||0<player[a].inputs.rAnalog[0])return player[a].phys.cVel.x*
player[a].phys.face>player[a].charAttributes.dMaxV&&(player[a].phys.cVel.x=player[a].charAttributes.dMaxV*player[a].phys.face),aS[73].init(a),!0;if(39<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=
tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"SIDESPECIAL",canPassThrough:!1,canEdgeCancel:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=56;player[a].timer=0;player[a].phys.grounded?player[a].phys.cVel.x*=.2:(player[a].phys.sideBJumpFlag?(player[a].phys.cVel.y=1,player[a].phys.sideBJumpFlag=!1):player[a].phys.cVel.y=0,player[a].phys.fastfalled=!1,player[a].phys.cVel.x*=.8);turnOffHitboxes(a);
player[a].hitboxes.id0=player[a].charHitboxes.sidespecial.id0;player[a].hitboxes.id1=player[a].charHitboxes.sidespecial.id1;player[a].hitboxes.id2=player[a].charHitboxes.sidespecial.id2;player[a].hitboxes.id3=player[a].charHitboxes.sidespecial.id3;aS[56].main(a)},main:function(a){player[a].timer++;aS[56].interrupt(a)||(player[a].phys.grounded?reduceByTraction(a,!0):(player[a].phys.cVel.y-=.06,0<player[a].phys.cVel.x?(player[a].phys.cVel.x-=.0025,0>player[a].phys.cVel.x&&(player[a].phys.cVel.x=0)):
(player[a].phys.cVel.x+=.0025,0<player[a].phys.cVel.x&&(player[a].phys.cVel.x=0))),6==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),6<player[a].timer&&9>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 29<player[a].timer?(player[a].phys.grounded?aS[0].init(a):aS[13].init(a),!0):!1}},{name:"FSMASH",canEdgeCancel:!1,init:function(a){player[a].actionState=57;player[a].timer=0;player[a].phys.charging=
!1;player[a].phys.chargeFrames=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.fsmash.id0;player[a].hitboxes.id1=player[a].charHitboxes.fsmash.id1;player[a].hitboxes.id2=player[a].charHitboxes.fsmash.id2;player[a].hitboxes.id3=player[a].charHitboxes.fsmash.id3;aS[57].main(a)},main:function(a){3==player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=
!1)):(player[a].timer++,player[a].phys.charging=!1):(player[a].timer++,player[a].phys.charging=!1);aS[57].interrupt(a)||(reduceByTraction(a,!0),10==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),10<player[a].timer&&14>player[a].timer&&player[a].hitboxes.frame++,14==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(49<player[a].timer)return aS[0].init(a),!0;if(47<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),
!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"UPSMASH",canEdgeCancel:!1,init:function(a){player[a].actionState=58;player[a].timer=0;player[a].phys.charging=!1;
player[a].phys.chargeFrames=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.upsmash.id0;player[a].hitboxes.id1=player[a].charHitboxes.upsmash.id1;player[a].hitboxes.id2=player[a].charHitboxes.upsmash.id2;player[a].hitboxes.id3=player[a].charHitboxes.upsmash.id3;aS[58].main(a)},main:function(a){7==player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=
!1)):(player[a].timer++,player[a].phys.charging=!1):(player[a].timer++,player[a].phys.charging=!1);aS[58].interrupt(a)||(reduceByTraction(a,!0),13==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),13<player[a].timer&&17>player[a].timer&&player[a].hitboxes.frame++,17==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(54<player[a].timer)return aS[0].init(a),!0;if(45<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),
!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"DSMASH",canEdgeCancel:!1,init:function(a){player[a].actionState=59;player[a].timer=0;player[a].phys.charging=!1;player[a].phys.chargeFrames=
0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.dsmash1.id0;player[a].hitboxes.id1=player[a].charHitboxes.dsmash1.id1;player[a].hitboxes.id2=player[a].charHitboxes.dsmash1.id2;player[a].hitboxes.id3=player[a].charHitboxes.dsmash1.id3;aS[59].main(a)},main:function(a){3==player[a].timer?player[a].inputs.a[0]||player[a].inputs.z[0]?(player[a].phys.charging=!0,player[a].phys.chargeFrames++,60==player[a].phys.chargeFrames&&(player[a].timer++,player[a].phys.charging=!1)):(player[a].timer++,
player[a].phys.charging=!1):(player[a].timer++,player[a].phys.charging=!1);aS[59].interrupt(a)||(reduceByTraction(a,!0),5==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),5<player[a].timer&&8>player[a].timer&&player[a].hitboxes.frame++,8==player[a].timer&&turnOffHitboxes(a),20==player[a].timer&&(player[a].hitboxes.id0=player[a].charHitboxes.dsmash2.id0,player[a].hitboxes.id1=player[a].charHitboxes.dsmash2.id1,player[a].hitboxes.id2=player[a].charHitboxes.dsmash2.id2,
player[a].hitboxes.id3=player[a].charHitboxes.dsmash2.id3,player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),20<player[a].timer&&23>player[a].timer&&player[a].hitboxes.frame++,23==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){if(64<player[a].timer)return aS[0].init(a),!0;if(61<player[a].timer){var b=checkForSpecials(a),d=checkForTilts(a),e=checkForSmashes(a);if(checkForJump(a))return aS[8].init(a),!0;if(b[0])return aS[b[1]].init(a),!0;if(e[0])return aS[e[1]].init(a),
!0;if(d[0])return aS[d[1]].init(a),!0;if(checkForDash(a))return aS[1].init(a),!0;if(checkForSmashTurn(a))return aS[3].init(a),!0;if(checkForTiltTurn(a))return player[a].phys.dashbuffer=tiltTurnDashBuffer(a),aS[4].init(a),!0;if(.3<Math.abs(player[a].inputs.lStickAxis[0].x))return aS[7].init(a,!0),!0}return!1}},{name:"DOWNBOUND",canEdgeCancel:!0,init:function(a){player[a].actionState=60;player[a].timer=0;player[a].phys.kVel.y=0;drawVfx("groundBounce",player[a].phys.pos,player[a].phys.face);aS[60].main(a)},
main:function(a){player[a].timer++;aS[60].interrupt(a)||(1==player[a].timer?reduceByTraction(a,!0):player[a].phys.cVel.x=0)},interrupt:function(a){return 26<player[a].timer?(aS[61].init(a),!0):!1}},{name:"DOWNWAIT",canEdgeCancel:!0,init:function(a){player[a].actionState=61;player[a].timer=0;aS[61].main(a)},main:function(a){player[a].timer++;aS[61].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 300<player[a].timer?(aS[62].init(a),!0):-.7>player[a].inputs.lStickAxis[0].x*player[a].phys.face?
(aS[63].init(a),!0):.7<player[a].inputs.lStickAxis[0].x*player[a].phys.face?(aS[64].init(a),!0):.7<player[a].inputs.lStickAxis[0].y?(aS[62].init(a),!0):player[a].inputs.a[0]&&!player[a].inputs.a[1]||player[a].inputs.b[0]&&!player[a].inputs.b[1]?(aS[65].init(a),!0):!1}},{name:"DOWNSTANDN",canEdgeCancel:!0,init:function(a){player[a].actionState=62;player[a].timer=0;aS[62].main(a)},main:function(a){player[a].timer++;aS[62].interrupt(a)||(reduceByTraction(a,!0),1==player[a].timer&&(player[a].phys.intangibleTimer=
22))},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNSTANDB",canEdgeCancel:!1,setVelocities:[-.185,-.37,-.573,-1.54,-1.614,-1.586,-1.566,-1.614,-1.647,-1.666,-1.669,-1.657,-1.63,-1.588,-1.531,-1.397,-1.224,-1.094,-1.006,-.962,-.96,-.926,-.816,-.684,-.529,-.352,-.226,-.171,-.124,-.084,-.051,-.025,-.007,.004,.008],init:function(a){player[a].actionState=63;player[a].timer=0;aS[63].main(a)},main:function(a){player[a].timer++;aS[63].interrupt(a)||(player[a].phys.cVel.x=
aS[63].setVelocities[player[a].timer-1]*player[a].phys.face,1==player[a].timer&&(player[a].phys.intangibleTimer=19))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNSTANDF",canEdgeCancel:!1,setVelocities:[.467,1.36,1.733,2.135,2.355,2.581,2.055,2.281,2.184,1.902,1.703,1.521,1.357,1.211,1.082,.971,.878,.802,.743,.703,.68,.674,.686,.716,.763,.775,.727,.661,.577,.474,.352,.241,.163,.101,.055],init:function(a){player[a].actionState=64;player[a].timer=0;aS[64].main(a)},
main:function(a){player[a].timer++;aS[64].interrupt(a)||(player[a].phys.cVel.x=aS[64].setVelocities[player[a].timer-1]*player[a].phys.face,6==player[a].timer&&(player[a].phys.intangibleTimer=14))},interrupt:function(a){return 35<player[a].timer?(aS[0].init(a),!0):!1}},{name:"DOWNATTACK",canEdgeCancel:!1,init:function(a){player[a].actionState=65;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.downattack1.id0;player[a].hitboxes.id1=player[a].charHitboxes.downattack1.id1;
player[a].hitboxes.id2=player[a].charHitboxes.downattack1.id2;player[a].hitboxes.id3=player[a].charHitboxes.downattack1.id3;aS[65].main(a)},main:function(a){player[a].timer++;aS[65].interrupt(a)||(reduceByTraction(a,!0),1==player[a].timer&&(player[a].phys.intangibleTimer=31),20==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),20<player[a].timer&&24>player[a].timer&&player[a].hitboxes.frame++,24==player[a].timer&&turnOffHitboxes(a),30==player[a].timer&&(player[a].hitboxes.id0=
player[a].charHitboxes.downattack2.id0,player[a].hitboxes.id1=player[a].charHitboxes.downattack2.id1,player[a].hitboxes.id2=player[a].charHitboxes.downattack2.id2,player[a].hitboxes.id3=player[a].charHitboxes.downattack2.id3,player[a].hitboxes.active=[!0,!0,!0,!0],player[a].hitboxes.frame=0),30<player[a].timer&&32>player[a].timer&&player[a].hitboxes.frame++,32==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 49<player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHN",canEdgeCancel:!0,
init:function(a){player[a].actionState=66;player[a].timer=0;drawVfx("tech",player[a].phys.pos);aS[66].main(a)},main:function(a){player[a].timer++;aS[66].interrupt(a)||(reduceByTraction(a,!0),1==player[a].timer&&(player[a].phys.intangibleTimer=20))},interrupt:function(a){return 26<player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHB",canEdgeCancel:!1,setVelocities:[0,0,0,0,0,0,0,-2.832,-2.726,-2.622,-2.521,-2.422,-2.326,-2.233,-2.142,-2.054,-1.968,-1.885,-1.811,-1.748,-1.691,-1.639,-1.593,-1.553,-1.519,
-1.49,-1.467,-1.45,-1.439,-1.433,-1.433,-.002,-.003,-.004,-.005,-.006,-.006,-.007,-.007,-.006],init:function(a){player[a].actionState=67;player[a].timer=0;drawVfx("tech",player[a].phys.pos);aS[67].main(a)},main:function(a){player[a].timer++;aS[67].interrupt(a)||(1==player[a].timer&&(player[a].phys.intangibleTimer=20),player[a].phys.cVel.x=aS[67].setVelocities[player[a].timer-1]*player[a].phys.face)},interrupt:function(a){return 40<player[a].timer?(aS[0].init(a),!0):!1}},{name:"TECHF",canEdgeCancel:!1,
setVelocities:[0,0,0,0,0,0,0,4.036,3.526,2.726,2.317,1.862,1.656,1.625,1.768,1.989,2.094,2.083,1.956,1.846,1.814,1.757,1.676,1.57,1.44,1.286,1.107,.949,.834,.727,.629,.54,.459,.387,.323,.268,.222,.184,.155,.135],init:function(a){player[a].actionState=68;player[a].timer=0;drawVfx("tech",player[a].phys.pos);aS[68].main(a)},main:function(a){player[a].timer++;aS[68].interrupt(a)||(1==player[a].timer&&(player[a].phys.intangibleTimer=20),player[a].phys.cVel.x=aS[68].setVelocities[player[a].timer-1]*player[a].phys.face)},
interrupt:function(a){return 40<player[a].timer?(aS[0].init(a),!0):!1}},{name:"SHIELDBREAKFALL",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=69;player[a].timer=0;aS[69].main(a)},main:function(a){player[a].timer++;aS[69].interrupt(a)||(player[a].phys.intangibleTimer=1,player[a].phys.cVel.y-=player[a].charAttributes.gravity)},interrupt:function(a){return 30<player[a].timer?(aS[69].init(a),!0):!1}},{name:"SHIELDBREAKDOWNBOUND",canEdgeCancel:!0,init:function(a){player[a].actionState=
70;player[a].timer=0;player[a].phys.cVel.y=0;player[a].phys.kVel.y=0;drawVfx("groundBounce",player[a].phys.pos,player[a].phys.face);aS[70].main(a)},main:function(a){player[a].timer++;aS[70].interrupt(a)||(player[a].phys.intangibleTimer=1,1==player[a].timer?reduceByTraction(a,!0):player[a].phys.cVel.x=0)},interrupt:function(a){return 26<player[a].timer?(aS[71].init(a),!0):!1}},{name:"SHIELDBREAKSTAND",canEdgeCancel:!0,init:function(a){player[a].actionState=71;player[a].timer=0;aS[71].main(a)},main:function(a){player[a].timer++;
aS[71].interrupt(a)||(reduceByTraction(a,!0),player[a].phys.intangibleTimer=1)},interrupt:function(a){return 30<player[a].timer?(aS[72].init(a),!0):!1}},{name:"FURAFURA",canEdgeCancel:!0,init:function(a){player[a].actionState=72;player[a].timer=0;player[a].phys.stuckTimer=490;drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+(4+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+11+3*Math.random()),player[a].phys.face);aS[72].main(a)},main:function(a){player[a].timer++;aS[72].interrupt(a)||
(reduceByTraction(a,!0),0==player[a].timer%49&&drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+(3+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+11+3*Math.random()),player[a].phys.face),20==player[a].timer%49&&drawVfx("furaFura",new Vec2D(player[a].phys.pos.x+(5+2*Math.random())*player[a].phys.face,player[a].phys.pos.y+8+3*Math.random()),player[a].phys.face),30<player[a].phys.shieldHP&&(player[a].phys.shieldHP=30),player[a].phys.stuckTimer--,mashOut(a)&&(player[a].phys.stuckTimer-=3))},
...
!0),7==player[a].timer&&(player[a].hitboxes.active=[!0,!0,!0,!1],player[a].hitboxes.frame=0),7<player[a].timer&&9>player[a].timer&&player[a].hitboxes.frame++,9==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"CAPTUREPULLED",canEdgeCancel:!1,init:function(a){player[a].actionState=74;player[a].timer=0;player[a].phys.grounded=!0;player[a].phys.face=-1*player[player[a].phys.grabbedBy].phys.face;player[a].phys.onSurface=player[player[a].phys.grabbedBy].phys.onSurface;
player[a].phys.stuckTimer=100+2*player[a].percent;aS[74].main(a)},main:function(a){player[a].timer++;aS[74].interrupt(a)||2!=player[a].timer||(player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x+-16.41205*player[a].phys.face,player[player[a].phys.grabbedBy].phys.pos.y))},interrupt:function(a){return 2<player[a].timer?(aS[76].init(player[a].phys.grabbedBy),aS[75].init(a),drawVfx("tech",new Vec2D(player[a].phys.pos.x,player[a].phys.pos.y+10)),!0):!1}},{name:"CAPTUREWAIT",canEdgeCancel:!1,
init:function(a){player[a].actionState=75;player[a].timer=0;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x+-9.04298*player[a].phys.face,player[player[a].phys.grabbedBy].phys.pos.y);aS[75].main(a)},main:function(a){player[a].timer++;aS[75].interrupt(a)||(player[a].phys.stuckTimer--,mashOut(a)?(player[a].phys.stuckTimer-=3,player[a].phys.pos.x+=.5*Math.sign(Math.random()-.5)):player[a].phys.pos.x=player[player[a].phys.grabbedBy].phys.pos.x+-9.04298*player[a].phys.face)},interrupt:function(a){return 0>
...
(aS[87].init(a),!0):1<player[a].timer?(aS[76].init(a),!0):!1}},{name:"CAPTURECUT",canEdgeCancel:!1,canGrabLedge:[!0,!1],wallJumpAble:!1,init:function(a){player[a].actionState=77;player[a].timer=0;player[a].phys.grabbedBy=-1;player[a].phys.cVel.x=-1*player[a].phys.face;aS[77].main(a)},main:function(a){player[a].timer++;aS[77].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 30<player[a].timer?(aS[0].init(a),!0):!1}},{name:"CATCHCUT",canEdgeCancel:!1,canGrabLedge:[!0,!1],init:function(a){player[a].actionState=
78;player[a].timer=0;player[a].phys.grabbing=-1;player[a].phys.cVel.x=-1*player[a].phys.face;aS[78].main(a)},main:function(a){player[a].timer++;aS[78].interrupt(a)||reduceByTraction(a,!0)},interrupt:function(a){return 29<player[a].timer?(aS[0].init(a),!0):!1}},{name:"CATCHATTACK",canEdgeCancel:!1,init:function(a){player[a].actionState=79;player[a].timer=0;turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.pummel.id0;aS[79].main(a)},main:function(a){player[a].timer++;aS[79].interrupt(a)||
(6==player[a].timer&&(player[a].hitboxes.active=[!0,!1,!1,!1],player[a].hitboxes.frame=0),7==player[a].timer&&turnOffHitboxes(a))},interrupt:function(a){return 24<player[a].timer?(aS[76].init(a),!0):!1}},{name:"CAPTUREDAMAGE",canEdgeCancel:!1,setPositions:[9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.478,9.306,8.92,8.516,8.29,8.293,8.41,8.593,8.792,8.959,9.043,9.068],init:function(a){player[a].actionState=80;player[a].timer=0;aS[80].main(a)},main:function(a){player[a].timer++;aS[80].interrupt(a)||
(player[a].phys.pos.x=player[player[a].phys.grabbedBy].phys.pos.x+-aS[80].setPositions[player[a].timer-1]*player[a].phys.face)},interrupt:function(a){return 20<player[a].timer?(aS[75].init(a),!0):!1}},{name:"THROWUP",canEdgeCancel:!1,init:function(a){player[a].actionState=81;player[a].timer=0;aS[82].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwup.id0;aS[81].main(a)},main:function(a){player[a].timer++;aS[81].interrupt(a)||11!=player[a].timer||
(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,!1]),turnOffHitboxes(a))},interrupt:function(a){return 39<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):11>player[a].timer&&player[player[a].phys.grabbing].phys.grabbedBy!=a?(console.log("test"),aS[78].init(a),!0):!1}},{name:"THROWNUP",canEdgeCancel:!1,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=82;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,
player[player[a].phys.grabbedBy].phys.pos.y);aS[82].main(a)},main:function(a){player[a].timer++;aS[82].interrupt(a)},interrupt:function(a){return!1}},{name:"THROWDOWN",canEdgeCancel:!1,init:function(a){player[a].actionState=83;player[a].timer=0;aS[84].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwdown.id0;aS[83].main(a)},main:function(a){player[a].timer++;aS[83].interrupt(a)||13!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,
!0,!0]),turnOffHitboxes(a))},interrupt:function(a){return 37<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):13>player[a].timer&&player[player[a].phys.grabbing].phys.grabbedBy!=a?(console.log("test"),aS[78].init(a),!0):!1}},{name:"THROWNDOWN",canEdgeCancel:!1,reverseModel:!0,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=84;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.face*=-1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,
player[player[a].phys.grabbedBy].phys.pos.y);aS[84].main(a)},main:function(a){player[a].timer++;aS[84].interrupt(a)},interrupt:function(a){return!1}},{name:"THROWBACK",canEdgeCancel:!1,init:function(a){player[a].actionState=85;player[a].timer=0;aS[86].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwback.id0;aS[85].main(a)},main:function(a){player[a].timer++;aS[85].interrupt(a)||7!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,0,!1,!0,
!0]),turnOffHitboxes(a))},interrupt:function(a){return 39<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):7>player[a].timer&&player[player[a].phys.grabbing].phys.grabbedBy!=a?(aS[78].init(a),!0):!1}},{name:"THROWNBACK",canEdgeCancel:!1,reverseModel:!0,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=86;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.face*=-1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,
player[player[a].phys.grabbedBy].phys.pos.y);aS[86].main(a)},main:function(a){player[a].timer++;aS[86].interrupt(a)},interrupt:function(a){return!1}},{name:"THROWFORWARD",canEdgeCancel:!1,init:function(a){player[a].actionState=87;player[a].timer=0;aS[88].init(player[a].phys.grabbing);turnOffHitboxes(a);player[a].hitboxes.id0=player[a].charHitboxes.throwforward.id0;aS[87].main(a)},main:function(a){player[a].timer++;aS[87].interrupt(a)||13!=player[a].timer||(hitQueue.push([player[a].phys.grabbing,a,
0,!1,!0,!0]),turnOffHitboxes(a))},interrupt:function(a){return 27<player[a].timer?(player[a].phys.grabbing=-1,aS[0].init(a),!0):13>player[a].timer&&player[player[a].phys.grabbing].phys.grabbedBy!=a?(aS[78].init(a),!0):!1}},{name:"THROWNFORWARD",canEdgeCancel:!1,canGrabLedge:[!1,!1],init:function(a){player[a].actionState=88;player[a].timer=player[a].phys.grabbedBy<a?-1:0;player[a].phys.grounded=!1;player[a].phys.pos=new Vec2D(player[player[a].phys.grabbedBy].phys.pos.x,player[player[a].phys.grabbedBy].phys.pos.y);
aS[88].main(a)},main:function(a){player[a].timer++;aS[88].interrupt(a)},interrupt:function(a){return!1}},{name:"WALLDAMAGE",canPassThrough:!1,canGrabLedge:[!1,!1],wallJumpAble:!1,init:function(a){player[a].actionState=89;player[a].timer=0;aS[89].main(a)},main:function(a){player[a].timer++;0==player[a].hit.hitstun%10&&drawVfx("flyingDust",player[a].phys.pos);2==player[a].timer&&(player[a].phys.kVel.y*=.8,player[a].phys.kVel.x*=-.8,player[a].phys.kDec.x*=-1);aS[89].interrupt(a)||(player[a].hit.hitstun--,
...
10;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[90].main(a)},main:function(a){1>player[a].timer?(player[a].timer+=.15,1<player[a].timer&&(player[a].timer=1)):player[a].timer++;aS[90].interrupt(a)||(.89<player[a].timer&&.91>player[a].timer&&(player[a].phys.cVel.x=.5*player[a].phys.face),1<=player[a].timer&&(fastfall(a),airDrift(a)))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&
!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):26<player[a].timer?(aS[13].init(a),!0):!1}},{name:"WALLJUMP",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=91;player[a].timer=0;player[a].hit.hitstun=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=
0;player[a].phys.intangibleTimer=10;player[a].phys.cVel.x=1.3*player[a].phys.face;player[a].phys.cVel.y=2.4;player[a].hit.hitlag=5;player[a].hit.knockback=0;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[91].main(a)},main:function(a){player[a].timer++;aS[91].interrupt(a)||(fastfall(a),airDrift(a))},interrupt:function(a){var b=checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||
player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):40<player[a].timer?(aS[13].init(a),!0):!1}},{name:"WALLTECHJUMP",canPassThrough:!0,canGrabLedge:[!0,!1],wallJumpAble:!0,init:function(a){player[a].actionState=92;player[a].timer=0;player[a].hit.hitstun=0;player[a].phys.kVel.y=0;player[a].phys.kVel.x=0;player[a].phys.cVel.x=
0;player[a].phys.cVel.y=0;player[a].phys.intangibleTimer=10;1==player[a].phys.face?drawVfx("tech",player[a].phys.ECBp[3]):drawVfx("tech",player[a].phys.ECBp[1]);aS[92].main(a)},main:function(a){1>player[a].timer?(player[a].timer+=.15,1<player[a].timer&&(player[a].timer=1)):player[a].timer++;aS[90].interrupt(a)||(.89<player[a].timer&&.91>player[a].timer&&(player[a].phys.cVel.x=1.3*player[a].phys.face,player[a].phys.cVel.y=2.4),1<=player[a].timer&&(fastfall(a),airDrift(a)))},interrupt:function(a){var b=
checkForAerials(a),d=checkForSpecials(a);return b[0]?(aS[b[1]].init(a),!0):player[a].inputs.l[0]&&!player[a].inputs.l[1]||player[a].inputs.r[0]&&!player[a].inputs.r[1]?(aS[11].init(a),!0):(player[a].inputs.x[0]&&!player[a].inputs.x[1]||player[a].inputs.y[0]&&!player[a].inputs.y[1])&&!player[a].phys.doubleJumped?(aS[19].init(a),!0):d[0]?(aS[d[1]].init(a),!0):40<player[a].timer?(aS[13].init(a),!0):!1}},{name:"SLEEP",init:function(a){player[a].actionState=93;player[a].timer=0;player[a].hit.hitstun=0;
player[a].phys.kVel.y=0;player[a].phys.kVel.x=0;player[a].phys.cVel.x=0;player[a].phys.cVel.y=0;player[a].phys.pos.x=300;aS[93].main(a)},main:function(a){},interrupt:function(a){return!1}},{name:"ENTRANCE",init:function(a){player[a].actionState=94;player[a].timer=0;player[a].phys.grounded=!1;aS[94].main(a)},main:function(a){player[a].timer++;aS[94].interrupt(a)},interrupt:function(a){60<player[a].timer&&aS[13].init(a)}}];twoPi=2*Math.PI;
