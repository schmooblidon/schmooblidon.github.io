...
(e=0);n=-1*m.axes[map.csY[mType[a]]]-cd[a].cs.y;f=m.axes[map.csX[mType[a]]]-cd[a].cs.x;f/=.75;n/=.75;f=1<f?1:-1>f?-1:Math.round(80*f)/80;n=1<n?1:-1>n?-1:Math.round(80*n)/80;.3>Math.abs(f)&&(f=0);.3>Math.abs(n)&&(n=0);q=m.axes[map.lA[mType[a]]]-cd[a].l;h=m.axes[map.rA[mType[a]]]-cd[a].r;q+=.9;h+=.9;1<q&&(q=1);1<h&&(h=1);.3>q&&(q=0);.3>h&&(h=0)}pause[a][1]=pause[a][0];frameAdvance[a][1]=frameAdvance[a][0];4==mType[a]?(pause[a][0]=keys[109]?!0:!1,frameAdvance[a][0]=keys[107]?!0:!1):(pause[a][0]=m.buttons[map.s[mType[a]]].pressed?
!0:!1,frameAdvance[a][0]=m.buttons[map.z[mType[a]]].pressed?!0:!1);if(b){for(var g=0;7>g;g++)player[a].inputs.lStickAxis[7-g].x=player[a].inputs.lStickAxis[6-g].x,player[a].inputs.lStickAxis[7-g].y=player[a].inputs.lStickAxis[6-g].y,player[a].inputs.cStickAxis[7-g].x=player[a].inputs.cStickAxis[6-g].x,player[a].inputs.cStickAxis[7-g].y=player[a].inputs.cStickAxis[6-g].y,player[a].inputs.lAnalog[7-g]=player[a].inputs.lAnalog[6-g],player[a].inputs.rAnalog[7-g]=player[a].inputs.rAnalog[6-g],player[a].inputs.z[7-
g]=player[a].inputs.z[6-g],player[a].inputs.a[7-g]=player[a].inputs.a[6-g],player[a].inputs.b[7-g]=player[a].inputs.b[6-g],player[a].inputs.x[7-g]=player[a].inputs.x[6-g],player[a].inputs.y[7-g]=player[a].inputs.y[6-g],player[a].inputs.r[7-g]=player[a].inputs.r[6-g],player[a].inputs.l[7-g]=player[a].inputs.l[6-g],player[a].inputs.dpadleft[7-g]=player[a].inputs.dpadleft[6-g],player[a].inputs.dpaddown[7-g]=player[a].inputs.dpaddown[6-g],player[a].inputs.dpadright[7-g]=player[a].inputs.dpadright[6-g],
player[a].inputs.dpadup[7-g]=player[a].inputs.dpadup[6-g];player[a].inputs.lStickAxis[0].x=d;player[a].inputs.lStickAxis[0].y=e;player[a].inputs.cStickAxis[0].x=f;player[a].inputs.cStickAxis[0].y=n;player[a].inputs.lAnalog[0]=q;player[a].inputs.rAnalog[0]=h;4==mType[a]?(player[a].inputs.x[0]=keys[102],player[a].inputs.a[0]=keys[101],player[a].inputs.b[0]=keys[100],player[a].inputs.y[0]=keys[104],player[a].inputs.r[0]=keys[105],player[a].inputs.l[0]=keys[103],player[a].inputs.dpadleft[0]=keys[86],
player[a].inputs.dpaddown[0]=keys[66],player[a].inputs.dpadright[0]=keys[78],player[a].inputs.dpadup[0]=keys[71]):(player[a].inputs.x[0]=m.buttons[map.x[mType[a]]].pressed,player[a].inputs.a[0]=m.buttons[map.a[mType[a]]].pressed,player[a].inputs.b[0]=m.buttons[map.b[mType[a]]].pressed,player[a].inputs.y[0]=m.buttons[map.y[mType[a]]].pressed,player[a].inputs.r[0]=m.buttons[map.r[mType[a]]].pressed,player[a].inputs.l[0]=m.buttons[map.l[mType[a]]].pressed,player[a].inputs.dpadleft[0]=m.buttons[map.dl[mType[a]]].pressed,
