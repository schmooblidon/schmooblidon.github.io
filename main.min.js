...
function customDeadzone(){this.ls=new Vec2D(0,0);this.cs=new Vec2D(0,0);this.r=this.l=0}keyboardMap=[102,101,100,104,103,105,107,109,71,78,66,86];keyboardOccupied=!1;map={a:[1,0,4,0],b:[2,1,3,1],x:[0,2,2,2],y:[3,3,1,3],z:[7,4,7,7],r:[5,5,6,5],l:[4,6,5,4],s:[9,7,0,9],du:[12,8,8,12],dr:[13,11,10,13],dd:[14,9,9,14],dl:[15,10,11,15],lsX:[0,0,0,0],lsY:[1,1,1,1],csX:[5,3,3,2],csY:[2,4,4,3],lA:[3,2,5,6],rA:[4,5,6,7]};console.log("raphnet update!");mType=[0,0,0,0];
cd=[new customDeadzone,new customDeadzone,new customDeadzone,new customDeadzone];currentPlayers=[];playerAmount=0;playerType=[-1,-1,-1,-1];ports=0;activePorts=[];frameByFrame=playing=!1;showVfx=findingPlayers=!0;showDebug=!1;gameMode=0;charSelect=["marth","marth","marth","marth"];randomTags="NEO! SELF NOVA PNDA Panda LFFN Scorp AZ AXE Tempo TMPO [A]rmada WBALLZ Westballz PPMD Kreygasm M2K Mang0 USA SCAR TOPH (.Y.) HBOX HungryBox PLUP Shroomed SFAT Wizz Lucky S2J SilentWolf aMSa S2J Hax$".split(" ");
vfxQueue=[];
palettes=[["rgb(250, 89, 89)","rgb(255, 170, 170)","rgba(255, 206, 111, ","rgba(244, 68, 68, 0.6)","rgba(255, 225, 167, "],["rgb(4, 255, 134)","rgb(154, 254, 170)","rgba(252, 95, 95, ","rgba(255, 182, 96, 0.6)","rgba(254, 141, 141, "],["rgb(5, 195, 255)","rgb(121, 223, 255)","rgba(218, 96, 254, ","rgba(231, 134, 255, 0.6)","rgba(230, 144, 255, "],["rgb(255, 187, 70)","rgb(248, 255, 122)","rgba(80, 182, 255, ","rgba(255, 142, 70, 0.6)","rgba(139, 203, 249, "],["rgb(177, 89, 255)","rgb(203, 144, 255)","rgba(144, 255, 110, ",
"rgba(247, 126, 250, 0.6)","rgba(190, 255, 170, "],["rgb(182, 131, 70)","rgb(252, 194, 126)","rgba(47, 186, 123, ","rgba(255, 112, 66, 0.6)","rgba(111, 214, 168, "],["rgb(166, 166, 166)","rgb(255, 255, 255)","rgba(255, 255, 255, ","rgba(191, 119, 119, 0.6)","rgba(175, 172, 172, "]];hurtboxColours=["rgba(255, 237, 70, 0.6)","rgba(42, 57, 255, 0.6)","rgba(54, 255, 37, 0.6)"];hasTag=[!1,!1,!1,!1];tagText=["","","",""];pPal=[0,1,2,3];costumeTimeout=[];
...
(e=0);n=-1*m.axes[map.csY[mType[a]]]-cd[a].cs.y;f=m.axes[map.csX[mType[a]]]-cd[a].cs.x;f/=.75;n/=.75;f=1<f?1:-1>f?-1:Math.round(80*f)/80;n=1<n?1:-1>n?-1:Math.round(80*n)/80;.3>Math.abs(f)&&(f=0);.3>Math.abs(n)&&(n=0);3==mType[a]?(q=m.buttons[map.lA[mType[a]]]-cd[a].l,h=m.buttons[map.rA[mType[a]]]-cd[a].r):(q=m.axes[map.lA[mType[a]]]-cd[a].l,h=m.axes[map.rA[mType[a]]]-cd[a].r,2==mType[a]&&(q*=-1,h*=-1),q+=.9,h+=.9);1<q&&(q=1);1<h&&(h=1);.3>q&&(q=0);.3>h&&(h=0)}pause[a][1]=pause[a][0];frameAdvance[a][1]=
frameAdvance[a][0];4==mType[a]?(pause[a][0]=keys[109]?!0:!1,frameAdvance[a][0]=keys[107]?!0:!1):(pause[a][0]=m.buttons[map.s[mType[a]]].pressed?!0:!1,frameAdvance[a][0]=m.buttons[map.z[mType[a]]].pressed?!0:!1);if(b){for(var g=0;7>g;g++)player[a].inputs.lStickAxis[7-g].x=player[a].inputs.lStickAxis[6-g].x,player[a].inputs.lStickAxis[7-g].y=player[a].inputs.lStickAxis[6-g].y,player[a].inputs.cStickAxis[7-g].x=player[a].inputs.cStickAxis[6-g].x,player[a].inputs.cStickAxis[7-g].y=player[a].inputs.cStickAxis[6-
...
g],player[a].inputs.dpaddown[7-g]=player[a].inputs.dpaddown[6-g],player[a].inputs.dpadright[7-g]=player[a].inputs.dpadright[6-g],player[a].inputs.dpadup[7-g]=player[a].inputs.dpadup[6-g];player[a].inputs.lStickAxis[0].x=d;player[a].inputs.lStickAxis[0].y=e;player[a].inputs.cStickAxis[0].x=f;player[a].inputs.cStickAxis[0].y=n;player[a].inputs.lAnalog[0]=q;player[a].inputs.rAnalog[0]=h;4==mType[a]?(player[a].inputs.x[0]=keys[102],player[a].inputs.a[0]=keys[101],player[a].inputs.b[0]=keys[100],player[a].inputs.y[0]=
keys[104],player[a].inputs.r[0]=keys[105],player[a].inputs.l[0]=keys[103],player[a].inputs.dpadleft[0]=keys[86],player[a].inputs.dpaddown[0]=keys[66],player[a].inputs.dpadright[0]=keys[78],player[a].inputs.dpadup[0]=keys[71]):(player[a].inputs.x[0]=m.buttons[map.x[mType[a]]].pressed,player[a].inputs.a[0]=m.buttons[map.a[mType[a]]].pressed,player[a].inputs.b[0]=m.buttons[map.b[mType[a]]].pressed,player[a].inputs.y[0]=m.buttons[map.y[mType[a]]].pressed,player[a].inputs.r[0]=m.buttons[map.r[mType[a]]].pressed,
player[a].inputs.l[0]=m.buttons[map.l[mType[a]]].pressed,player[a].inputs.dpadleft[0]=m.buttons[map.dl[mType[a]]].pressed,player[a].inputs.dpaddown[0]=m.buttons[map.dd[mType[a]]].pressed,player[a].inputs.dpadright[0]=m.buttons[map.dr[mType[a]]].pressed,player[a].inputs.dpadup[0]=m.buttons[map.du[mType[a]]].pressed);frameByFrame||(player[a].inputs.z[0]=4==mType[a]?keys[107]:m.buttons[map.z[mType[a]]].pressed,player[a].inputs.z[0]&&(player[a].inputs.lAnalog[0]=.35,player[a].inputs.a[0]=!0));player[a].inputs.l[0]&&
(player[a].inputs.lAnalog[0]=1);player[a].inputs.r[0]&&(player[a].inputs.rAnalog[0]=1)}else 4==mType[a]?keys[101]&&keys[103]&&keys[105]&&keys[109]&&(keys[100]?startGame():endGame()):m.buttons[map.a[mType[a]]].pressed&&m.buttons[map.l[mType[a]]].pressed&&m.buttons[map.r[mType[a]]].pressed&&m.buttons[map.s[mType[a]]].pressed&&(m.buttons[map.b[mType[a]]].pressed?startGame():endGame()),frameAdvance[a][0]&&!frameAdvance[a][1]&&(frameByFrame=!0);player[a].inputs.dpadleft[0]&&!player[a].inputs.dpadleft[1]&&
(player[a].showLedgeGrabBox^=1);player[a].inputs.dpaddown[0]&&!player[a].inputs.dpaddown[1]&&(player[a].showECB^=1);player[a].inputs.dpadright[0]&&!player[a].inputs.dpadright[1]&&(player[a].showHitbox^=1);4!=mType[a]&&m.buttons[map.du[mType[a]]].pressed&&m.buttons[map.x[mType[a]]].pressed&&m.buttons[map.y[mType[a]]].pressed&&!attemptingControllerReset[a]&&(attemptingControllerReset[a]=!0,setTimeout(function(){m.buttons[map.du[mType[a]]].pressed&&m.buttons[map.x[mType[a]]].pressed&&m.buttons[map.y[mType[a]]].pressed&&
(cd[a].ls=new Vec2D(m.axes[0],-1*m.axes[1]),cd[a].cs=new Vec2D(m.axes[5],-1*m.axes[2]),cd[a].l=m.axes[3]+.8,cd[a].r=m.axes[4]+.8,$("#resetIndicator"+a).fadeIn(100),$("#resetIndicator"+a).fadeOut(500));attemptingControllerReset[a]=!1},2E3));pause[a][0]&&!pause[a][1]&&3==gameMode&&((playing^=1)||renderForeground());0<player[a].phys.lCancelTimer&&(player[a].phys.lCancelTimer--,0==player[a].phys.lCancelTimer&&(player[a].phys.lCancel=!1));0==player[a].phys.lCancelTimer&&(0<player[a].inputs.lAnalog[0]&&
0==player[a].inputs.lAnalog[1]||0<player[a].inputs.rAnalog[0]&&0==player[a].inputs.lAnalog[1]||player[a].inputs.z[0]&&!player[a].inputs.z[1])&&(player[a].phys.lCancelTimer=7,player[a].phys.lCancel=!0);$("#lsAxisX"+a).empty().append(d.toFixed(5));$("#lsAxisY"+a).empty().append(e.toFixed(5));$("#lAnalog"+a).empty().append(q.toFixed(5));$("#rAnalog"+a).empty().append(h.toFixed(5));if(4==mType[a])for(g=0;12>g;g++)keys[keyboardMap[g]]?$("#"+a+"button"+g).show():$("#"+a+"button"+g).hide();else for(g=0;12>
g;g++)d=g,0==mType[a]&&(5<d&&d++,7<d&&d++,8<d&&(d+=2)),m.buttons[d].pressed?$("#"+a+"button"+g).show():$("#"+a+"button"+g).hide()}
