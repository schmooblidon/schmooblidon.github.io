...
player[a].a.j);sounds.tech.play();aS[66].l(a)},l:function(a){player[a].c++;aS[66].m(a)||(C(a,!0),1==player[a].c&&(player[a].a.aa=20))},m:function(a){return 26<player[a].c?(aS[0].f(a),!0):!1}},{name:"TECHB",H:!1,w:!0,oa:[0,0,0,0,0,0,0,-2.832,-2.726,-2.622,-2.521,-2.422,-2.326,-2.233,-2.142,-2.054,-1.968,-1.885,-1.811,-1.748,-1.691,-1.639,-1.593,-1.553,-1.519,-1.49,-1.467,-1.45,-1.439,-1.433,-1.433,-.002,-.003,-.004,-.005,-.006,-.006,-.007,-.007,-.006],f:function(a){player[a].o=67;player[a].c=0;n("tech",
player[a].a.j);sounds.tech.play();aS[67].l(a)},l:function(a){player[a].c++;aS[67].m(a)||(1==player[a].c&&(player[a].a.aa=20),player[a].a.g.x=aS[67].oa[player[a].c-1]*player[a].a.face)},m:function(a){return 40<player[a].c?(aS[0].f(a),!0):!1}},{name:"TECHF",H:!1,w:!0,oa:[0,0,0,0,0,0,0,4.036,3.526,2.726,2.317,1.862,1.656,1.625,1.768,1.989,2.094,2.083,1.956,1.846,1.814,1.757,1.676,1.57,1.44,1.286,1.107,.949,.834,.727,.629,.54,.459,.387,.323,.268,.222,.184,.155,.135],f:function(a){player[a].o=68;player[a].c=
0;n("tech",player[a].a.j);sounds.tech.play();aS[68].l(a)},l:function(a){player[a].c++;aS[68].m(a)||(1==player[a].c&&(player[a].a.aa=20),player[a].a.g.x=aS[68].oa[player[a].c-1]*player[a].a.face)},m:function(a){return 40<player[a].c?(aS[0].f(a),!0):!1}},{name:"SHIELDBREAKFALL",ca:!1,w:!0,V:[!1,!1],ga:!1,da:!1,f:function(a){player[a].o=69;player[a].c=0;aS[69].l(a)},l:function(a){player[a].c++;aS[69].m(a)||(player[a].a.aa=1,player[a].a.g.y-=player[a].C.Gb)},m:function(a){return 30<player[a].c?(aS[69].f(a),
