function Hit(percent, damage, growth, base, setKnockback, trajectory, character, version, xPos, yPos, crouch, reverse, chargeInterrupt, tdiX, tdiY, fadeIn, doubleJump, sdix, sdiy, adix, adiy, meteorCancel, vcancel, grounded) {
    ...
    function getKnockback(percent, damage, weight, growth, base, setKnockback, crouch, chargeInterrupt, vcancel, grounded, trajectory) {
      if (setKnockback == 0){
    ...
    function knockbackTravel(horizontalVelocity, horizontalDecay, verticalVelocity, verticalDecay, character, hitstun, xPos, yPos, fadeIn, doubleJump, sdiVector, asdiVector, trajectory, meteorCancel, grounded, angle) {
        var positions = [];
        var hPos = xPos;
        var vPos = yPos;
        var horVelChar = 0;
    ...
    var knockback = getKnockback(percent, damage, weight, growth, base, setKnockback, crouch, chargeInterrupt, vcancel, grounded, trajectory);
    ...
    this.positions = knockbackTravel(horizontalVelocity, horizontalDecay, verticalVelocity, verticalDecay, character, hitstun, xPos, yPos, fadeIn, doubleJump, sdiVector, asdiVector, trajectory, meteorCancel, grounded, angle);
